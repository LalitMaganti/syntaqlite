...
impl<'a> ColumnRef<'a> {
    ...
    pub fn table(&self) -> &'a str {
        self.raw.table.as_str(self.stmt_result.source())
    }
...
impl<'a> ColumnConstraint<'a> {
    ...
    pub fn constraint_name(&self) -> &'a str {
        self.raw.constraint_name.as_str(self.stmt_result.source())
    }
    ...
    pub fn collation_name(&self) -> &'a str {
        self.raw.collation_name.as_str(self.stmt_result.source())
    }
...
impl<'a> CreateVirtualTableStmt<'a> {
    ...
    pub fn module_name(&self) -> &'a str {
        self.raw.module_name.as_str(self.stmt_result.source())
    }
    pub fn if_not_exists(&self) -> bool {
        self.raw.if_not_exists == super::ffi::Bool::True
    }
    pub fn module_args(&self) -> &'a str {
        self.raw.module_args.as_str(self.stmt_result.source())
    }
}
...
impl<'a> PragmaStmt<'a> {
    ...
    pub fn value(&self) -> &'a str {
        self.raw.value.as_str(self.stmt_result.source())
    }
