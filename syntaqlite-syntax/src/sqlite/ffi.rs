...
#[derive(Debug, Clone)]
#[repr(C)]
pub(crate) struct ForeignKeyOption {
    pub(crate) tag: u32,
    pub(crate) kind: super::ast::ForeignKeyOptionKind,
    pub(crate) action: super::ast::ForeignKeyAction,
...
#[derive(Debug, Clone)]
#[repr(C)]
pub(crate) struct ConstraintNameDeclaration {
    pub(crate) tag: u32,
...
#[derive(Debug, Clone)]
#[repr(C)]
pub(crate) struct ParenTableSource {
    pub(crate) tag: u32,
    pub(crate) source: AnyNodeId,
    pub(crate) alias: AnyNodeId,
    pub(crate) alias_as: Bool,
...
// SAFETY: TAG matches the value the C parser writes into the `tag` field.
unsafe impl ArenaNode for ForeignKeyOption {
    const TAG: u32 = 15;
}
...
// SAFETY: TAG matches the value the C parser writes into the `tag` field.
unsafe impl ArenaNode for ConstraintNameDeclaration {
    const TAG: u32 = 19;
}
...
// SAFETY: TAG matches the value the C parser writes into the `tag` field.
unsafe impl ArenaNode for ParenExpr {
    const TAG: u32 = 40;
}
...
// SAFETY: TAG matches the value the C parser writes into the `tag` field.
unsafe impl ArenaNode for RowValue {
    const TAG: u32 = 43;
}
