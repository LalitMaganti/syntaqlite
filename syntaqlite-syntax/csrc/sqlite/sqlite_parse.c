...
static const YYCODETYPE yy_lookahead[] = {
    /*     0 */ 208, 244, 224, 193, 193, 5,   214, 215, 230, 210,
    ...
    /*    80 */ 268, 206, 272, 272, 285, 208, 199, 288, 301, 279,
    ...
    /*   230 */ 102, 103, 104, 232, 244, 93,  94,  95,  96,  97,
    ...
    /*   550 */ 37,  38,  206, 161, 107, 108, 109, 261, 22,  23,
    ...
    /*   990 */ 35,  36,  37,  38,  97,  98,  193, 206, 195, 193,
    /*  1000 */ 257, 198, 11,  264, 35,  36,  37,  38,  40,  206,
    /*  1010 */ 113, 268, 206, 269, 206, 24,  193, 93,  94,  95,
    ...
    /*  1070 */ 101, 102, 103, 104, 24,  107, 108, 109, 272, 29,
    /*  1080 */ 193, 90,  195, 40,  193, 208, 195, 206, 97,  98,
    /*  1090 */ 40,  214, 215, 206, 248, 272, 105, 206, 107, 108,
    /*  1100 */ 109, 110, 111, 1,   113, 55,  133, 24,  135, 136,
    /*  1110 */ 137, 272, 193, 267, 146, 124, 125, 205, 145, 128,
    /*  1120 */ 208, 206, 245, 21,  74,  206, 214, 215, 193, 79,
    /*  1130 */ 195, 244, 197, 90,  262, 244, 11,  199, 147, 206,
    /*  1140 */ 90,  206, 151, 152, 153, 40,  44,  97,  98,  24,
    /*  1150 */ 107, 108, 161, 110, 111, 105, 284, 107, 108, 109,
    /*  1160 */ 110, 111, 271, 113, 62,  40,  61,  206, 125, 193,
    /*  1170 */ 208, 195, 193, 197, 124, 125, 214, 215, 128, 244,
    /*  1180 */ 55,  76,  206, 78,  64,  206, 81,  193, 68,  106,
    /*  1190 */ 107, 272, 193, 206, 151, 152, 206, 264, 279, 74,
    /*  1200 */ 206, 151, 152, 153, 79,  206, 271, 245, 321, 206,
    /*  1210 */ 323, 11,  107, 108, 109, 90,  200, 201, 199, 114,
    /*  1220 */ 244, 206, 97,  98,  24,  191, 192, 193, 194, 65,
    /*  1230 */ 105, 67,  107, 108, 109, 110, 111, 243, 113, 249,
    /*  1240 */ 40,  206, 252, 253, 210, 211, 212, 271, 165, 124,
    /*  1250 */ 125, 272, 193, 128, 193, 55,  136, 117, 279, 119,
    /*  1260 */ 193, 199, 324, 325, 261, 206, 272, 206, 309, 310,
    /*  1270 */ 236, 272, 238, 206, 74,  155, 151, 152, 153, 79,
    /*  1280 */ 189, 190, 191, 192, 193, 194, 193, 193, 254, 195,
    /*  1290 */ 90,  40,  198, 232, 233, 24,  132, 97,  98,  206,
    /*  1300 */ 206, 210, 211, 212, 243, 105, 61,  107, 108, 109,
    /*  1310 */ 110, 111, 24,  113, 0,   27,  210, 211, 4,   155,
    /*  1320 */ 6,   206, 8,   78,  124, 125, 81,  236, 128, 238,
    /*  1330 */ 16,  272, 18,  272, 20,  248, 302, 11,  244, 272,
    /*  1340 */ 306, 307, 308, 324, 325, 254, 279, 114, 97,  98,
    /*  1350 */ 24,  151, 152, 153, 267, 84,  41,  106, 107, 108,
    /*  1360 */ 109, 110, 111, 118, 285, 272, 40,  288, 54,  193,
    /*  1370 */ 109, 57,  279, 10,  206, 104, 62,  63,  206, 118,
    /*  1380 */ 66,  55,  206, 69,  269, 134, 324, 325, 117, 40,
    /*  1390 */ 14,  206, 141, 302, 106, 19,  125, 306, 307, 308,
    /*  1400 */ 167, 206, 88,  206, 133, 134, 135, 136, 137, 138,
    /*  1410 */ 1,   48,  306, 307, 11,  144, 90,  241, 206, 243,
    /*  1420 */ 90,  45,  59,  97,  98,  164, 112, 24,  203, 204,
    /*  1430 */ 21,  105, 144, 107, 108, 109, 110, 111, 108, 113,
    /*  1440 */ 110, 111, 206, 40,  206, 113, 193, 11,  272, 117,
    /*  1450 */ 124, 125, 126, 44,  128, 125, 261, 108, 55,  206,
    /*  1460 */ 24,  147, 113, 140, 141, 142, 117, 58,  154, 92,
    /*  1470 */ 156, 62,  157, 159, 5,   161, 40,  151, 152, 153,
    /*  1480 */ 166, 151, 152, 193, 15,  193, 193, 195, 195, 206,
    /*  1490 */ 113, 55,  115, 90,  287, 118, 206, 92,  206, 206,
    /*  1500 */ 97,  98,  210, 211, 212, 269, 143, 269, 105, 216,
    /*  1510 */ 107, 108, 109, 110, 111, 314, 113, 118, 113, 206,
    /*  1520 */ 115, 320, 24,  118, 314, 272, 90,  124, 125, 126,
    /*  1530 */ 320, 128, 142, 97,  98,  99,  244, 244, 139, 118,
    /*  1540 */ 150, 105, 109, 107, 108, 109, 110, 111, 115, 113,
    /*  1550 */ 142, 118, 269, 314, 151, 152, 153, 11,  150, 320,
    /*  1560 */ 124, 125, 272, 271, 128, 4,   314, 6,   147, 8,
    /*  1570 */ 24,  193, 320, 195, 203, 204, 198, 16,  206, 18,
    /*  1580 */ 115, 20,  161, 118, 206, 87,  40,  151, 152, 153,
    /*  1590 */ 193, 193, 195, 195, 197, 197, 114, 164, 306, 307,
    /*  1600 */ 118, 55,  106, 206, 206, 203, 204, 210, 211, 212,
    /*  1610 */ 203, 204, 118, 48,  40,  54,  203, 204, 57,  148,
    /*  1620 */ 149, 127, 244, 62,  63,  115, 40,  66,  118, 65,
    /*  1630 */ 69,  67,  193, 193, 195, 195, 90,  198, 198, 74,
    /*  1640 */ 27,  244, 244, 97,  98,  206, 206, 121, 83,  88,
    /*  1650 */ 42,  105, 126, 107, 108, 109, 110, 111, 89,  113,
    /*  1660 */ 34,  165, 206, 118, 206, 193, 206, 195, 271, 271,
    /*  1670 */ 124, 125, 127, 112, 128, 4,   223, 6,   206, 8,
    /*  1680 */ 206, 116, 108, 244, 244, 115, 40,  16,  118, 18,
    /*  1690 */ 40,  117, 125, 193, 108, 195, 132, 151, 152, 153,
    /*  1700 */ 281, 134, 316, 306, 307, 193, 206, 195, 147, 206,
    /*  1710 */ 198, 115, 72,  73,  118, 154, 244, 156, 206, 106,
    /*  1720 */ 159, 113, 161, 154, 206, 54,  206, 166, 57,  193,
    /*  1730 */ 193, 195, 195, 62,  63,  198, 206, 66,  115, 113,
    /*  1740 */ 69,  118, 206, 206, 244, 14,  115, 206, 193, 118,
    /*  1750 */ 195, 193, 267, 195, 108, 193, 244, 195, 108, 88,
    /*  1760 */ 115, 206, 206, 118, 206, 193, 115, 195, 206, 118,
    /*  1770 */ 198, 271, 206, 193, 115, 195, 45,  118, 206, 115,
    /*  1780 */ 244, 244, 118, 193, 206, 195, 206, 193, 193, 195,
    /*  1790 */ 195, 275, 193, 289, 195, 193, 206, 195, 293, 244,
    /*  1800 */ 206, 206, 244, 110, 111, 206, 244, 271, 206, 193,
    /*  1810 */ 115, 195, 115, 118, 281, 118, 244, 115, 147, 219,
    /*  1820 */ 118, 281, 206, 281, 244, 154, 271, 156, 115, 271,
    /*  1830 */ 159, 118, 161, 271, 244, 114, 115, 166, 244, 244,
    /*  1840 */ 193, 115, 195, 244, 118, 193, 244, 195, 193, 193,
    /*  1850 */ 195, 195, 281, 206, 115, 110, 111, 118, 206, 196,
    /*  1860 */ 244, 206, 206, 193, 207, 195, 278, 193, 193, 195,
    /*  1870 */ 195, 193, 193, 195, 195, 258, 206, 193, 259, 195,
    /*  1880 */ 206, 206, 113, 265, 206, 206, 258, 265, 119, 297,
    /*  1890 */ 206, 244, 193, 193, 195, 195, 244, 270, 259, 244,
    /*  1900 */ 244, 259, 193, 270, 195, 206, 206, 259, 297, 220,
    /*  1910 */ 234, 193, 222, 195, 244, 206, 286, 245, 244, 244,
    /*  1920 */ 237, 286, 244, 244, 206, 193, 265, 195, 244, 193,
    /*  1930 */ 286, 195, 218, 245, 193, 286, 195, 193, 206, 195,
    /*  1940 */ 146, 245, 206, 244, 244, 196, 305, 206, 262, 262,
    /*  1950 */ 206, 13,  119, 244, 63,  193, 303, 195, 193, 193,
    /*  1960 */ 195, 195, 244, 303, 193, 193, 195, 195, 206, 209,
    /*  1970 */ 209, 206, 206, 209, 160, 277, 244, 206, 206, 193,
    /*  1980 */ 244, 195, 193, 277, 195, 244, 276, 276, 244, 193,
    /*  1990 */ 41,  195, 206, 276, 193, 206, 195, 278, 278, 193,
    /*  2000 */ 91,  195, 206, 274, 274, 149, 244, 206, 274, 244,
    /*  2010 */ 244, 274, 206, 260, 266, 244, 244, 113, 193, 193,
    /*  2020 */ 195, 195, 163, 193, 193, 195, 195, 114, 22,  262,
    /*  2030 */ 244, 206, 206, 244, 256, 262, 206, 206, 263, 193,
    /*  2040 */ 244, 195, 193, 263, 195, 244, 209, 193, 91,  195,
    /*  2050 */ 244, 240, 206, 148, 193, 206, 195, 270, 240, 193,
    /*  2060 */ 206, 195, 209, 193, 193, 195, 195, 206, 270, 244,
    /*  2070 */ 244, 193, 206, 195, 244, 244, 206, 206, 193, 193,
    /*  2080 */ 195, 195, 260, 260, 206, 270, 193, 193, 195, 195,
    /*  2090 */ 244, 206, 206, 244, 193, 266, 195, 256, 244, 206,
    /*  2100 */ 206, 256, 270, 113, 246, 244, 209, 206, 240, 129,
    /*  2110 */ 244, 295, 43,  294, 244, 244, 209, 240, 193, 209,
    /*  2120 */ 195, 240, 244, 106, 229, 246, 46,  229, 229, 244,
    /*  2130 */ 244, 206, 113, 225, 246, 235, 139, 244, 244, 220,
    /*  2140 */ 229, 235, 225, 229, 229, 244, 118, 229, 209, 162,
    /*  2150 */ 263, 262, 283, 263, 242, 116, 282, 80,  315, 315,
    /*  2160 */ 71,  113, 270, 213, 209, 104, 129, 251, 217, 244,
    /*  2170 */ 117, 251, 250, 246, 310, 273, 273, 168, 313, 231,
    /*  2180 */ 325, 205, 205, 205, 205, 313, 221, 231, 221, 219,
    /*  2190 */ 219, 231, 49,  205, 50,  113, 112, 157, 115, 158,
    /*  2200 */ 115, 157, 132, 124, 147, 146, 143, 117, 127, 118,
    /*  2210 */ 165, 113, 106, 155, 112, 127, 143, 143, 132, 42,
    ...
    /*  2260 */ 115, 115, 115, 9,   113, 164, 118, 9,   115, 113,
    /*  2270 */ 9,   117, 114, 118, 115, 113, 119, 116, 148, 113,
    /*  2280 */ 115, 9,   9,   9,   77,  60,  23,  75,  60,  118,
    /*  2290 */ 9,   82,  118, 115, 115, 115, 127, 87,  113, 113,
    /*  2300 */ 118, 18,  118, 9,   9,   326, 326, 112, 115, 113,
    /*  2310 */ 118, 326, 113, 326, 127, 115, 113, 119, 326, 115,
    /*  2320 */ 326, 115, 121, 326, 326, 326, 113, 326, 326, 326,
    /*  2330 */ 326, 112, 115, 119, 119, 113, 115, 326, 326, 326,
    ...
    */
    ...
    case 178: /* expr ::= expr PLUS|MINUS expr */
    {
      ...
      yylhsminor.yy277 = synq_parse_binary_expr(pCtx, op, yymsp[-2].minor.yy277,
                                                yymsp[0].minor.yy277);
      synq_source_bind_rhs(pCtx, yylhsminor.yy277, SYNQ_SOURCE_OPERATOR, 1, 2);
    }
      yymsp[-2].minor.yy277 = yylhsminor.yy277;
      break;
    ...
    case 212: /* sortorder ::= ASC */
    {
      ...
      // token while Lemon is reducing; original comments remain
      // source-faithful.
                 ...
                 nmorerr */
    {
      ...
      synq_source_bind_rhs(pCtx, yymsp[-7].minor.yy277, SYNQ_SOURCE_PREFIX, 4,
                           5);
    } break;
    case 233: /* cmd ::= ALTER TABLE fullname DROP kwcolumn_opt nmorerr */
    {
      ...
      synq_source_bind_rhs(pCtx, yymsp[-5].minor.yy277, SYNQ_SOURCE_PREFIX, 4,
                           5);
    } break;
                 ...
                 columnname carglist */
    {
      ...
      synq_source_bind_rhs(pCtx, yymsp[-6].minor.yy277, SYNQ_SOURCE_PREFIX, 4,
                           5);
    } break;
    ...
    case 239: /* cmd ::= BEGIN transtype trans_opt */
    {
      yymsp[-2].minor.yy277 = synq_parse_transaction_stmt(
          ...
          yymsp[0].minor.yy0.z ? synq_span(pCtx, yymsp[0].minor.yy0)
                               : SYNQ_NO_SPAN);
      synq_source_bind_rhs(pCtx, yymsp[-2].minor.yy277, SYNQ_SOURCE_OPERATOR, 0,
                           1);
    } break;
    case 240: /* cmd ::= COMMIT|END trans_opt */
    {
      yymsp[-1].minor.yy277 = synq_parse_transaction_stmt(
          ...
          yymsp[0].minor.yy0.z ? synq_span(pCtx, yymsp[0].minor.yy0)
                               : SYNQ_NO_SPAN);
      synq_source_bind_rhs(pCtx, yymsp[-1].minor.yy277, SYNQ_SOURCE_OPERATOR, 0,
                           1);
    } break;
    ...
    case 252: /* cmd ::= RELEASE savepoint_opt nmorerr */
    {
      yymsp[-2].minor.yy277 =
          synq_parse_savepoint_stmt(pCtx, SYNTAQLITE_SAVEPOINT_OP_RELEASE,
                                    yymsp[0].minor.yy277, SYNQ_NO_SPAN);
      synq_source_bind_rhs(pCtx, yymsp[-2].minor.yy277, SYNQ_SOURCE_PREFIX, 1,
                           2);
    } break;
    case 253: /* cmd ::= ROLLBACK trans_opt TO savepoint_opt nmorerr */
    {
      yymsp[-4].minor.yy277 = synq_parse_savepoint_stmt(
          ...
          yymsp[-3].minor.yy0.z ? synq_span(pCtx, yymsp[-3].minor.yy0)
                                : SYNQ_NO_SPAN);
      synq_source_bind_rhs(pCtx, yymsp[-4].minor.yy277, SYNQ_SOURCE_PREFIX, 3,
                           4);
    } break;
    ...
    {
      yymsp[-1].minor.yy277 = synq_pass(pCtx, yymsp[0].minor.yy277);
      synq_source_bind_rhs(pCtx, yymsp[-1].minor.yy277, SYNQ_SOURCE_PREFIX, 0,
                           1);
    } break;
    case 265: /* as ::= ID|STRING */
    {
      yylhsminor.yy277 = synq_parse_ident_name(
          pCtx, synq_span_dequote(pCtx, yymsp[0].minor.yy0));
      synq_source_bind_rhs(pCtx, yylhsminor.yy277, SYNQ_SOURCE_PREFIX, 0, 0);
    }
      yymsp[0].minor.yy277 = yylhsminor.yy277;
      break;
                 ...
                 trigger_event ON fullname foreach_clause when_clause */
    {
      ...
      synq_source_bind_rhs(pCtx, yylhsminor.yy277, SYNQ_SOURCE_PREFIX, 5, 6);
    }
      yymsp[-10].minor.yy277 = yylhsminor.yy277;
      break;
