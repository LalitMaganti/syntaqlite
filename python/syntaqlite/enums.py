...
class NodeTag(IntEnum):
    ...
    SAVEPOINT_STMT = 48
    RESULT_COLUMN = 49
    RESULT_COLUMN_LIST = 50
    SELECT_STMT = 51
    ORDERING_TERM = 52
    ORDER_BY_LIST = 53
    LIMIT_CLAUSE = 54
    TABLE_REF = 55
    SUBQUERY_TABLE_SOURCE = 56
    PAREN_TABLE_SOURCE = 57
    JOIN_CLAUSE = 58
    JOIN_PREFIX = 59
    TRIGGER_EVENT = 60
    TRIGGER_CMD_LIST = 61
    CREATE_TRIGGER_STMT = 62
    CREATE_VIRTUAL_TABLE_STMT = 63
    PRAGMA_STMT = 64
    ANALYZE_OR_REINDEX_STMT = 65
    ATTACH_STMT = 66
    DETACH_STMT = 67
    VACUUM_STMT = 68
    EXPLAIN_STMT = 69
    CREATE_INDEX_STMT = 70
    CREATE_VIEW_STMT = 71
    VALUES_ROW_LIST = 72
    VALUES_CLAUSE = 73
    FRAME_BOUND = 74
