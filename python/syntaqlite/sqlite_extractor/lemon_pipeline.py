...
# Lemon emits a comment referencing the temp dir path; always strip it.
_LEMON_SOURCE_COMMENT_RE = re.compile(
...
def run_lemon_pipeline(
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        # Strip Lemon's source file comment (contains temp dir path)
        parse_c_content = _LEMON_SOURCE_COMMENT_RE.sub('', parse_c_content)
