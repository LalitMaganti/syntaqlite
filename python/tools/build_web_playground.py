...
def main() -> int:
    ...
    # Build SQLite dialect wasm side module from C sources directly.
    # dialect.c is generated by codegen and exports syntaqlite_sqlite_dialect()
    # returning *const SyntaqliteDialectTemplate — no wrapper needed.
