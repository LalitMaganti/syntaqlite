...
static const YYACTIONTYPE yy_action[] = {
 /*     0 */  1586,    7,  574,  462,  522,  378, 1322,  130,  127,  234,
 /*    10 */   505, 1360,  574, 1339, 1375,  574,  372,  130,  127,  234,
 /*    20 */  1360,  462,  568,  462,  565,  574,  571,  464, 1257, 1290,
 /*    30 */    51, 1551,  295,  161,  290,  284, 1288,  413,  434, 1290,
 /*    40 */    51, 1259, 1290,   19,  534, 1325,  565,  299,  571, 1001,
 /*    50 */   264,  230, 1290,   60,  574,  499,  421, 1002,  130,  127,
 /*    60 */   234,  137,  139,   91,   48, 1228, 1228, 1072, 1075, 1062,
 /*    70 */  1062,  290, 1324, 1288,  290,  413, 1288,  290,  233, 1288,
 /*    80 */   539, 1290,   51,  565,  574,  571,  565,  535,  571,  565,
 /*    90 */  1032,  571,  568,  568,  516,  413,  499,  254,   44,  137,
 /*   100 */   139,   91,  267, 1228, 1228, 1072, 1075, 1062, 1062,  370,
 /*   110 */   434, 1290,   84,  303,  452,  130,  127,  234, 1631,  137,
 /*   120 */   139,   91,  574, 1228, 1228, 1072, 1075, 1062, 1062,  376,
 /*   130 */   376,  359,  301,  466,   48,  372, 1183,  377, 1183,  140,
 /*   140 */   377, 1550,  321,  575, 1310,  308,  556,  490,  361, 1290,
 /*   150 */    84,  420,  452,  521,  523,  135,  135,  136,  136,  136,
 /*   160 */   136,  134,  134,  134,  134,  133,  133,  132,  132,  132,
 /*   170 */   131,  128,  452,  304,  290,  290, 1288, 1288,  452,  547,
 /*   180 */  1290,   22,  547,  574,  556,  501,  565,  565,  571,  571,
 /*   190 */   452, 1156,  555,  135,  135,  136,  136,  136,  136,  134,
 /*   200 */   134,  134,  134,  133,  133,  132,  132,  132,  131,  128,
 /*   210 */  1290,   82,  452,  135,  135,  136,  136,  136,  136,  134,
 /*   220 */   134,  134,  134,  133,  133,  132,  132,  132,  131,  128,
 /*   230 */  1156,  413, 1225,   10,  110, 1363, 1225,  134,  134,  134,
 ...
 /*   280 */  1228, 1072, 1075, 1062, 1062, 1290,  145, 1312,  157,  413,
 /*   290 */   326, 1158, 1658, 1658, 1136,  398, 1363,   45,  505,  133,
 /*   300 */   133,  132,  132,  132,  131,  128,    6, 1312,  452, 1137,
 /*   310 */  1178,  413, 1210,  137,  139,   91, 1210, 1228, 1228, 1072,
 /*   320 */  1075, 1062, 1062, 1178,  954, 1197, 1178,  573,  452, 1208,
 /*   330 */  1208,  130,  127,  234,  955,  137,  139,   91, 1365, 1228,
 ...
 /*   390 */   875, 1059, 1059, 1073, 1076, 1049,  972,  478,  183, 1365,
 /*   400 */   209,  358, 1208,  867, 1520,  489,  875,  135,  135,  136,
 ...
 /*   440 */   133,  132,  132,  132,  131,  128, 1063,  413,  452,  918,
 ...
 /*   490 */   478,  477,  478,   46, 1290,   19,  456, 1520, 1522, 1520,
 /*   500 */   435, 1290,  147,  452,  131,  128,  321,  575,  294,  137,
 ...
 /*   560 */   128,  524,  452,  237,  911,  135,  135,  136,  136,  136,
 /*   570 */   136,  134,  134,  134,  134,  133,  133,  132,  132,  132,
 /*   580 */   131,  128, 1208, 1460, 1507,  183,  875, 1233, 1208, 1208,
 ...
 /*   620 */  1607,  137,  139,   91,  895, 1228, 1228, 1072, 1075, 1062,
 /*   630 */  1062,  380, 1460,  549,  413, 1208, 1208,  447,  446,  427,
 /*   640 */   525, 1208, 1208,  236,  574, 1208,  461,  458,  457,  875,
 /*   650 */   129, 1236,  548, 1236,  232,  413,  456, 1178,  137,  139,
 /*   660 */    91, 1189, 1228, 1228, 1072, 1075, 1062, 1062,  543,  212,
 /*   670 */  1178, 1290,   84, 1178,  452,  488,  510,  344,  988,  137,
 /*   680 */   139,   91,  507, 1228, 1228, 1072, 1075, 1062, 1062,  283,
 /*   690 */   407, 1288, 1208,  452, 1659,  402,  875,  382, 1208, 1189,
 /*   700 */   474,  565,  875,  571,  516, 1094,  556,  540,  540,    7,
 /*   710 */   322,  452,  542,  988,  444,  135,  135,  136,  136,  136,
 /*   720 */   136,  134,  134,  134,  134,  133,  133,  132,  132,  132,
 /*   730 */   131,  128,  452, 1387,  316, 1050,  136,  136,  136,  136,
 ...
 /*   790 */   413, 1356,  516, 1196,  137,  139,   91,  574, 1228, 1228,
 /*   800 */  1072, 1075, 1062, 1062,  409,   44, 1119, 1119,  513, 1208,
 /*   810 */  1208,  532, 1313,  574,  137,  139,   91,  107, 1228, 1228,
 /*   820 */  1072, 1075, 1062, 1062, 1290,   19,  370,  392,  413,  447,
 /*   830 */   446,  479,  557, 1459,  290, 1114, 1288,  516,  432, 1372,
 /*   840 */  1290,   84,  100, 1236,  526, 1236,  565,  452,  571,  321,
 /*   850 */   575,  302,  137,  139,   91,  302, 1228, 1228, 1072, 1075,
 /*   860 */  1062, 1062,  290,  497, 1288,  921, 1208,  452,  440,  921,
 /*   870 */   875,  436, 1208, 1208,  565,  556,  571, 1208, 1208, 1208,
 /*   880 */  1208,  380, 1459,  558, 1368,  368,  116,  390,  135,  135,
 ...
 /*   930 */   198,  533,  533,  875, 1208,  199, 1208,    5,  875,  413,
 /*   940 */   875,  490,  361,  436,  120,  215,  135,  135,  136,  136,
 /*   950 */   136,  136,  134,  134,  134,  134,  133,  133,  132,  132,
 /*   960 */   132,  131,  128,  137,  139,   91,  413, 1228, 1228, 1072,
 /*   970 */  1075, 1062, 1062,  518,  574,  524,  516, 1049, 1116, 1343,
 /*   980 */   512,  914, 1116, 1208,   42,  867,  574,  875, 1584,    7,
 /*   990 */   137,  139,   91, 1178, 1228, 1228, 1072, 1075, 1062, 1062,
 /*  1000 */   413, 1290,   84,  290,  552, 1288, 1178,  559,  511, 1178,
 /*  1010 */  1342,  406,  405, 1290,   19,  565,  452,  571,  491,  532,
 /*  1020 */    95, 1208, 1208,  366,  137,  126,   91,  437, 1228, 1228,
 /*  1030 */  1072, 1075, 1062, 1062,  429,  267,  528,  290,  914, 1288,
 ...
 /*  1070 */   132,  132,  131,  128, 1290,   53,  574,  452, 1208,  493,
 /*  1080 */   526,  413,  875,  536,  135,  135,  136,  136,  136,  136,
 /*  1090 */   134,  134,  134,  134,  133,  133,  132,  132,  132,  131,
 /*  1100 */   128,  305, 1458, 1290,   84,  213,  139,   91,  574, 1228,
 /*  1110 */  1228, 1072, 1075, 1062, 1062,  413, 1208, 1208,  135,  135,
 /*  1120 */   136,  136,  136,  136,  134,  134,  134,  134,  133,  133,
 /*  1130 */   132,  132,  132,  131,  128, 1290,   19,  241,  317,  574,
 /*  1140 */  1580,   91,  372, 1228, 1228, 1072, 1075, 1062, 1062,  442,
 /*  1150 */   380, 1458,  429, 1371,  576,  441,  966,  966,  452, 1579,
 /*  1160 */   372, 1208, 1208, 1208, 1208, 1225, 1290,   19,  883, 1225,
 /*  1170 */   884, 1340,  885, 1208,    3, 1315,  418,  875,    6,  124,
 /*  1180 */   207,  566, 1341,  290, 1197, 1288,  990,  417,  989,  574,
 /*  1190 */    50,  331,  452, 1585,    7,  565,  569,  571, 1321,  135,
 /*  1200 */   135,  136,  136,  136,  136,  134,  134,  134,  134,  133,
 /*  1210 */   133,  132,  132,  132,  131,  128, 1290,   19, 1208,  384,
 /*  1220 */  1208,  375,  875,  214,  875,  562, 1250,  441, 1208, 1208,
 /*  1230 */   208,  567,  418,  135,  135,  136,  136,  136,  136,  134,
 /*  1240 */   134,  134,  134,  133,  133,  132,  132,  132,  131,  128,
 /*  1250 */   124, 1561,  566,  574, 1049, 1197,  574,  372,  450,  450,
 /*  1260 */    50,  372,  867,  108,  372,  907,  160,  569, 1563,  907,
 /*  1270 */   574, 1583,    7,  574,  124,  574,  566,  506,  158, 1197,
 /*  1280 */  1290,   19, 1001, 1290,   84, 1208,  475,  401, 1249,  875,
 /*  1290 */  1002,  569,  228,   34,  550, 1559,  562, 1290,   84, 1250,
 /*  1300 */  1290,   84, 1290,   84,    9,   47,   44,  122,  122,  855,
 /*  1310 */   288,  230,   49,  453,  123,  450,    4,  574,  318,  572,
 /*  1320 */   562,  867,  867,  869, 1040, 1049,  291,  247, 1288,  450,
 /*  1330 */   450,  851,  445,  867,  545,  449,  850,  451,  565,  544,
 /*  1340 */   571,  241,  232, 1178, 1290,   54, 1582,    7,  934, 1049,
 /*  1350 */   321,  575,  426,  450,  450,  336, 1178,  867,  327, 1178,
 /*  1360 */   401, 1157,  422,  185,   34,  335,  988,  124,  298,  566,
 /*  1370 */  1244,  574, 1197,  470,  925,   47,  372,  574,  122,  122,
 /*  1380 */   574,  935,   49,  372,  569,  123,  450,    4,   34,  338,
 /*  1390 */   572,  417,  867,  867,  869, 1040, 1630,  943, 1290,   55,
 /*  1400 */   286,  988,  122,  122, 1290,   56,  330, 1290,   66,  123,
 /*  1410 */   450,    4,  480,  562,  572,  551,  867,  867,  869, 1040,
 /*  1420 */  1032,  574,  469, 1385,  424,  113,  121,  545,  118,  423,
 /*  1430 */  1135,  113,  546,  243,  280,  329,  472,  332,  471,  242,
 /*  1440 */   482,  574, 1049,  503,  483,  330,  450,  450, 1290,   67,
 /*  1450 */   867,  412, 1136, 1101,  124,  412,  566, 1101,  574, 1197,
 /*  1460 */   339,  359,  485,  347,  574,  495,  492, 1137, 1290,   21,
 /*  1470 */   340,  569,  240,  239,  238,  343,  496,  412,  320,  454,
 /*  1480 */   263,   34,  561,  324,  113, 1290,   57,  412,  574,  412,
 /*  1490 */   574, 1290,   68,  574, 1399,  122,  122,  574,  221,  940,
 /*  1500 */   562,  941,  123,  450,    4,  101,  218,  572,  574,  867,
 /*  1510 */   867,  869, 1040,  574,  545, 1290,   58, 1290,   69,  544,
 /*  1520 */  1290,   70,  504,  574, 1290,   71,  574,  222,  574, 1049,
 /*  1530 */   574,  551,  574,  450,  450, 1290,   72,  867,  574,  222,
 /*  1540 */  1290,   73,  574,  430,  574,  205,  574, 1153,  403,   39,
 /*  1550 */  1290,   74,  574, 1290,   75, 1290,   76, 1290,   77, 1290,
 /*  1560 */    59,  933,  932,  228,  138, 1290,   61,   38,   34, 1290,
 /*  1570 */    20, 1290,  143, 1290,  144,  877,  537,  357,  113, 1290,
 /*  1580 */    79, 1398,  122,  122, 1282,  484,  476,  582,  574,  123,
 /*  1590 */   450,    4,  574,  292,  572,  574,  867,  867,  869, 1040,
 /*  1600 */  1113,  574, 1113,  396, 1112,  396, 1112,  395,  166,  277,
 /*  1610 */   520,  393, 1034,  266, 1566, 1290,   62,  892,  574, 1290,
 /*  1620 */    80,  574, 1290,   63, 1004, 1005,  574,  352, 1290,   81,
 /*  1630 */   498,  266,  248, 1539,  342,  124,  574,  566,  500,  266,
 /*  1640 */  1197, 1538,  341,  508,   25, 1290,   64,  363, 1290,  170,
 /*  1650 */  1598,  574,  569, 1290,  171,   90,  574,  566,  289,  574,
 /*  1660 */  1197, 1041, 1620, 1290,   88, 1041,  250,  362,  113,  574,
 /*  1670 */  1395,  560,  569,  224,  177,  517,  574,   43, 1290,   65,
 /*  1680 */   574,  562, 1162, 1290,  146,  574, 1290,   83,  367, 1097,
 /*  1690 */   263,  371,  574, 1408,  249, 1447, 1290,  168,  574, 1268,
 /*  1700 */   574,  562, 1451, 1290,  148,  574,  389, 1290,  142, 1393,
 /*  1710 */  1049,  391, 1290,  169,  450,  450,  414,  574,  867, 1290,
 /*  1720 */   162,  321,  575,  574, 1301, 1290,  152, 1290,  151, 1300,
 /*  1730 */  1049, 1302, 1290,  149,  450,  450, 1613,  554,  867,  993,
 /*  1740 */   266,  165,  113,  281, 1290,  150,  970,  138, 1266,   34,
 /*  1750 */  1290,   86,  905,  159,  574,   12,  124,  553,  566,  313,
 /*  1760 */   167, 1197,  397,  122,  122,  971,  138,  873,  314,   34,
 /*  1770 */   123,  450,    4,  569,  315,  572,  227,  867,  867,  869,
 /*  1780 */  1040, 1290,   78,  122,  122, 1616,  476,  582,  968,  138,
 /*  1790 */   123,  450,    4,  292,  459,  572,  246,  867,  867,  869,
 /*  1800 */  1040, 1339,  562,  396,  334,  396, 1434,  395, 1429,  277,
 /*  1810 */   574,  393,  354,  300, 1424, 1439,  574,  892,  502, 1438,
 /*  1820 */   574,  410,  355,  306, 1511, 1510,  203,  360,  223, 1390,
 /*  1830 */  1391, 1049,  248,  210,  342,  450,  450, 1290,   87,  867,
 /*  1840 */   211,  563,  341, 1290,   85,  387, 1389, 1290,   52, 1388,
 /*  1850 */   400,  473, 1359, 1358, 1357,   40,   93,  463, 1627,  425,
 /*  1860 */  1350, 1629, 1628,  404, 1329,  925,  250, 1328, 1349, 1244,
 /*  1870 */    34,  333, 1327,  274,  177, 1558, 1556,   43,  187, 1241,
 /*  1880 */   100,  428, 1516, 1435,  122,  122,  220,  196,  476,  244,
 /*  1890 */    96,  123,  450,    4,  249,  292,  572,  182,  867,  867,
 /*  1900 */   869, 1040,   99,  189,  486,  396,  191,  396,  487,  395,
 /*  1910 */   192,  277,   13,  393,  193,  579,  414,  194,  256,  892,
 /*  1920 */   108,  321,  575,   15, 1443,  408,    2,  465, 1257, 1441,
 /*  1930 */  1440,  494,  295,  161,  248,  411,  342,  200, 1505,  106,
 /*  1940 */   509, 1259,  260,  262,  341,  515, 1527,  365,  282,  438,
 /*  1950 */   311,  519,  439,  369,  312,    2,  465, 1257,  268,  141,
 /*  1960 */  1379,  295,  161,  551,  269,  374,  443,  873,  250, 1412,
 /*  1970 */  1259,  290, 1589, 1288,  233,   11,  177, 1588, 1411,   43,
 /*  1980 */   381, 1603, 1492,  565,  117,  571,  319, 1261,  109,  216,
 /*  1990 */   529,  385,  386,  577,  388,  273,  249,  254, 1202, 1303,
 /*  2000 */   290,  276, 1288,  275,  278,  279,  580, 1298,  154, 1293,
 ...
 /*  2040 */  1198,  175,  153,  328,  217,  468,  923,  936,   94,  874,
 /*  2050 */   297,  176,  337,  245, 1255,    1, 1284,  156, 1111, 1109,
 /*  2060 */   345,  188,  466,  178,  877,  252,  190,  957,  353,  255,
 /*  2070 */  1125,  195,  179,  180,  433,  431,  102,  197,  181,  103,
 /*  2080 */   104,  105,  257, 1128, 1124, 1283,  258,  163,   26,  259,
 /*  2090 */   364, 1117,  266,  201, 1238,  514,  261,  202, 1163,  229,
 /*  2100 */   997,  265,  991,   27, 1164,  285,   16,  531,  287,  204,
 /*  2110 */    28,  112,  138, 1169,   41,  206, 1078,   29,  111,   30,
 /*  2120 */   164,  538,   31, 1194,    8, 1180, 1184, 1182, 1188,  113,
 /*  2130 */   114,   32, 1187,   33, 1092,  115, 1082, 1079, 1077,  965,
 /*  2140 */  1081,   18,  894,  270,  119, 1133,   35,  578,  394,  880,
 /*  2150 */    17,  564, 1042,  906,  125,   36,  581, 1287, 1256,  570,
...
static const YYACTIONTYPE yy_default[] = {
 /*     0 */  1663, 1663, 1663, 1500, 1254, 1386, 1254, 1254, 1254, 1254,
 /*    10 */  1500, 1500, 1500, 1254, 1254, 1254, 1254, 1254, 1254, 1415,
 /*    20 */  1415, 1553, 1258, 1254, 1254, 1254, 1254, 1254, 1254, 1254,
 /*    30 */  1254, 1254, 1254, 1254, 1499, 1254, 1254, 1254, 1254, 1254,
 /*    40 */  1254, 1587, 1587, 1254, 1254, 1254, 1254, 1572, 1571, 1254,
 /*    50 */  1254, 1254, 1421, 1254, 1254, 1254, 1254, 1254, 1426, 1501,
 /*    60 */  1502, 1254, 1254, 1254, 1254, 1254, 1552, 1554, 1517, 1433,
 /*    70 */  1432, 1431, 1430, 1535, 1404, 1277, 1420, 1423, 1501, 1496,
 /*    80 */  1497, 1495, 1641, 1254, 1502, 1422, 1464, 1463, 1480, 1254,
 ...
 /*   150 */  1465, 1467, 1468, 1311, 1361, 1254, 1254, 1254, 1254, 1254,
 /*   160 */  1254, 1308, 1469, 1258, 1457, 1456, 1455, 1254, 1483, 1470,
 ...
 /*   200 */  1254, 1254, 1254, 1254, 1254, 1406, 1254, 1587, 1587, 1258,
 /*   210 */  1587, 1587, 1316, 1407, 1407, 1316, 1272, 1567, 1265, 1265,
 /*   220 */  1265, 1265, 1386, 1265, 1254, 1254, 1254, 1254, 1254, 1254,
 ...
 /*   280 */  1320, 1254, 1530, 1374, 1269, 1269, 1269, 1269, 1271, 1264,
 /*   290 */  1260, 1373, 1294, 1633, 1336, 1254, 1331, 1415, 1655, 1436,
 /*   300 */  1425, 1270, 1425, 1652, 1276, 1436, 1436, 1276, 1436, 1270,
 /*   310 */  1652, 1415, 1415, 1406, 1406, 1406, 1406, 1272, 1272, 1498,
 /*   320 */  1270, 1264, 1508, 1362, 1362, 1362, 1354, 1254, 1254, 1362,
 /*   330 */  1351, 1508, 1362, 1336, 1362, 1351, 1362, 1655, 1655, 1392,
 /*   340 */  1392, 1654, 1654, 1392, 1518, 1639, 1445, 1364, 1370, 1370,
 /*   350 */  1370, 1370, 1392, 1305, 1276, 1639, 1639, 1276, 1445, 1364,
 /*   360 */  1276, 1364, 1276, 1392, 1305, 1534, 1649, 1392, 1305, 1254,
 /*   370 */  1512, 1512, 1508, 1392, 1275, 1272, 1597, 1597, 1418, 1418,
 /*   380 */  1605, 1503, 1392, 1254, 1275, 1274, 1273, 1276, 1508, 1392,
 /*   390 */  1305, 1392, 1305, 1615, 1615, 1611, 1611, 1611, 1626, 1626,
 /*   400 */  1338, 1660, 1660, 1567, 1338, 1320, 1320, 1626, 1258, 1258,
 /*   410 */  1258, 1258, 1258, 1254, 1254, 1254, 1254, 1254, 1621, 1254,
 /*   420 */  1254, 1254, 1254, 1254, 1254, 1254, 1254, 1562, 1519, 1396,
 /*   430 */  1254, 1254, 1254, 1254, 1254, 1254, 1254, 1254, 1573, 1254,
 /*   440 */  1254, 1254, 1254, 1254, 1254, 1254, 1254, 1254, 1254, 1254,
 /*   450 */  1449, 1254, 1254, 1254, 1254, 1254, 1254, 1254, 1254, 1254,
 /*   460 */  1254, 1254, 1309, 1254, 1254, 1254, 1564, 1334, 1254, 1254,
 /*   470 */  1254, 1254, 1254, 1254, 1254, 1254, 1254, 1254, 1254, 1254,
 /*   480 */  1254, 1254, 1427, 1428, 1397, 1254, 1254, 1254, 1254, 1254,
 /*   490 */  1254, 1254, 1442, 1254, 1254, 1254, 1437, 1254, 1254, 1254,
 /*   500 */  1254, 1254, 1254, 1254, 1254, 1651, 1254, 1254, 1254, 1254,
 /*   510 */  1254, 1254, 1533, 1532, 1254, 1254, 1394, 1254, 1254, 1254,
 /*   520 */  1254, 1254, 1254, 1254, 1254, 1254, 1254, 1254, 1419, 1254,
 /*   530 */  1254, 1254, 1254, 1602, 1254, 1254, 1254, 1254, 1254, 1254,
 /*   540 */  1254, 1254, 1254, 1254, 1254, 1254, 1254, 1254, 1254, 1254,
 /*   550 */  1410, 1254, 1254, 1254, 1254, 1254, 1642, 1254, 1254, 1254,
 /*   560 */  1254, 1254, 1254, 1254, 1254, 1636, 1254, 1254, 1254, 1254,
 /*   570 */  1254, 1381, 1280, 1450, 1254, 1254, 1376, 1254, 1254, 1254,
 /*   580 */  1299, 1254, 1291,
};
...
static const char *const yyRuleName[] = {
 ...
 /*  24 */ "term ::= INTEGER",
 /*  25 */ "input ::= cmdlist",
 /*  26 */ "cmdlist ::= cmdlist ecmd",
 /*  27 */ "cmdlist ::= ecmd",
 /*  28 */ "ecmd ::= SEMI",
 /*  29 */ "ecmd ::= cmdx SEMI",
 /*  30 */ "nm ::= STRING",
 /*  31 */ "selectnowith ::= oneselect",
 /*  32 */ "sclp ::= selcollist COMMA",
 /*  33 */ "expr ::= term",
 /*  34 */ "explain ::= EXPLAIN",
 /*  35 */ "explain ::= EXPLAIN QUERY PLAN",
 ...
 /* 116 */ "select ::= WITH wqlist selectnowith",
 /* 117 */ "select ::= WITH RECURSIVE wqlist selectnowith",
 ...
 /* 122 */ "oneselect ::= SELECT distinct selcollist from where_opt groupby_opt having_opt window_clause orderby_opt limit_opt",
 /* 123 */ "values ::= VALUES LP nexprlist RP",
 /* 124 */ "oneselect ::= mvalues",
 /* 125 */ "mvalues ::= values COMMA LP nexprlist RP",
 /* 126 */ "mvalues ::= mvalues COMMA LP nexprlist RP",
 /* 127 */ "selcollist ::= sclp scanpt nm DOT STAR",
 /* 128 */ "stl_prefix ::= seltablist joinop",
 /* 129 */ "stl_prefix ::=",
 /* 130 */ "seltablist ::= stl_prefix nm dbnm as on_using",
 /* 131 */ "seltablist ::= stl_prefix nm dbnm as indexed_by on_using",
 /* 132 */ "seltablist ::= stl_prefix nm dbnm LP exprlist RP as on_using",
 /* 133 */ "seltablist ::= stl_prefix LP select RP as on_using",
 /* 134 */ "seltablist ::= stl_prefix LP seltablist RP as on_using",
 /* 135 */ "dbnm ::=",
 /* 136 */ "dbnm ::= DOT nm",
 /* 137 */ "fullname ::= nm",
 /* 138 */ "fullname ::= nm DOT nm",
 /* 139 */ "xfullname ::= nm",
 /* 140 */ "xfullname ::= nm DOT nm",
 /* 141 */ "xfullname ::= nm DOT nm AS nm",
 /* 142 */ "xfullname ::= nm AS nm",
 /* 143 */ "joinop ::= COMMA|JOIN",
 /* 144 */ "joinop ::= JOIN_KW JOIN",
 /* 145 */ "joinop ::= JOIN_KW nm JOIN",
 /* 146 */ "joinop ::= JOIN_KW nm nm JOIN",
 /* 147 */ "on_using ::= ON expr",
 /* 148 */ "on_using ::= USING LP idlist RP",
 /* 149 */ "on_using ::=",
 /* 150 */ "indexed_opt ::=",
 /* 151 */ "indexed_by ::= INDEXED BY nm",
 /* 152 */ "indexed_by ::= NOT INDEXED",
 /* 153 */ "orderby_opt ::= ORDER BY sortlist",
 /* 154 */ "sortlist ::= sortlist COMMA expr sortorder nulls",
 /* 155 */ "sortlist ::= expr sortorder nulls",
 /* 156 */ "sortorder ::= ASC",
 /* 157 */ "sortorder ::= DESC",
 /* 158 */ "sortorder ::=",
 /* 159 */ "nulls ::= NULLS FIRST",
 /* 160 */ "nulls ::= NULLS LAST",
 /* 161 */ "nulls ::=",
 ...
 /* 167 */ "cmd ::= with DELETE FROM xfullname indexed_opt where_opt_ret",
 /* 168 */ "where_opt_ret ::=",
 /* 169 */ "where_opt_ret ::= WHERE expr",
 /* 170 */ "where_opt_ret ::= RETURNING selcollist",
 /* 171 */ "where_opt_ret ::= WHERE expr RETURNING selcollist",
 /* 172 */ "cmd ::= with UPDATE orconf xfullname indexed_opt SET setlist from where_opt_ret",
 /* 173 */ "setlist ::= setlist COMMA nm EQ expr",
 /* 174 */ "setlist ::= setlist COMMA LP idlist RP EQ expr",
 /* 175 */ "setlist ::= nm EQ expr",
 /* 176 */ "setlist ::= LP idlist RP EQ expr",
 /* 177 */ "cmd ::= with insert_cmd INTO xfullname idlist_opt select upsert",
 /* 178 */ "cmd ::= with insert_cmd INTO xfullname idlist_opt DEFAULT VALUES returning",
 /* 179 */ "upsert ::=",
 /* 180 */ "upsert ::= RETURNING selcollist",
 /* 181 */ "upsert ::= ON CONFLICT LP sortlist RP where_opt DO UPDATE SET setlist where_opt upsert",
 /* 182 */ "upsert ::= ON CONFLICT LP sortlist RP where_opt DO NOTHING upsert",
 /* 183 */ "upsert ::= ON CONFLICT DO NOTHING returning",
 /* 184 */ "upsert ::= ON CONFLICT DO UPDATE SET setlist where_opt returning",
 /* 185 */ "returning ::= RETURNING selcollist",
 /* 186 */ "insert_cmd ::= INSERT orconf",
 /* 187 */ "insert_cmd ::= REPLACE",
 /* 188 */ "idlist_opt ::=",
 /* 189 */ "idlist_opt ::= LP idlist RP",
 /* 190 */ "idlist ::= idlist COMMA nm",
 /* 191 */ "idlist ::= nm",
 /* 192 */ "expr ::= ID|INDEXED|JOIN_KW",
 /* 193 */ "expr ::= nm DOT nm",
 /* 194 */ "expr ::= nm DOT nm DOT nm",
 /* 195 */ "expr ::= VARIABLE",
...
static const YYCODETYPE yyRuleInfoLhs[] = {
   ...
   214,  /* (23) term ::= STRING */
   214,  /* (24) term ::= INTEGER */
   319,  /* (25) input ::= cmdlist */
   320,  /* (26) cmdlist ::= cmdlist ecmd */
   320,  /* (27) cmdlist ::= ecmd */
   321,  /* (28) ecmd ::= SEMI */
   321,  /* (29) ecmd ::= cmdx SEMI */
   187,  /* (30) nm ::= STRING */
   236,  /* (31) selectnowith ::= oneselect */
   251,  /* (32) sclp ::= selcollist COMMA */
   215,  /* (33) expr ::= term */
   191,  /* (34) explain ::= EXPLAIN */
   191,  /* (35) explain ::= EXPLAIN QUERY PLAN */
   193,  /* (36) cmd ::= BEGIN transtype trans_opt */
   194,  /* (37) transtype ::= */
   194,  /* (38) transtype ::= DEFERRED */
   194,  /* (39) transtype ::= IMMEDIATE */
   194,  /* (40) transtype ::= EXCLUSIVE */
   193,  /* (41) cmd ::= COMMIT|END trans_opt */
   193,  /* (42) cmd ::= ROLLBACK trans_opt */
   193,  /* (43) cmd ::= SAVEPOINT nm */
   193,  /* (44) cmd ::= RELEASE savepoint_opt nm */
   193,  /* (45) cmd ::= ROLLBACK trans_opt TO savepoint_opt nm */
   197,  /* (46) create_table ::= createkw temp TABLE ifnotexists nm dbnm */
   198,  /* (47) createkw ::= CREATE */
   200,  /* (48) ifnotexists ::= */
   200,  /* (49) ifnotexists ::= IF NOT EXISTS */
   199,  /* (50) temp ::= TEMP */
   199,  /* (51) temp ::= */
   202,  /* (52) create_table_args ::= LP columnlist conslist_opt RP table_option_set */
   202,  /* (53) create_table_args ::= AS select */
   205,  /* (54) table_option_set ::= */
   205,  /* (55) table_option_set ::= table_option_set COMMA table_option */
   207,  /* (56) table_option ::= WITHOUT nm */
   207,  /* (57) table_option ::= nm */
   208,  /* (58) columnname ::= nm typetoken */
   209,  /* (59) typetoken ::= */
   209,  /* (60) typetoken ::= typename LP signed RP */
   209,  /* (61) typetoken ::= typename LP signed COMMA signed RP */
   210,  /* (62) typename ::= typename ID|STRING */
   212,  /* (63) scantok ::= */
   213,  /* (64) ccons ::= CONSTRAINT nm */
   213,  /* (65) ccons ::= DEFAULT scantok term */
   213,  /* (66) ccons ::= DEFAULT LP expr RP */
   213,  /* (67) ccons ::= DEFAULT PLUS scantok term */
   213,  /* (68) ccons ::= DEFAULT MINUS scantok term */
   213,  /* (69) ccons ::= DEFAULT scantok ID|INDEXED */
   213,  /* (70) ccons ::= NOT NULL onconf */
   213,  /* (71) ccons ::= PRIMARY KEY sortorder onconf autoinc */
   213,  /* (72) ccons ::= UNIQUE onconf */
   213,  /* (73) ccons ::= CHECK LP expr RP */
   213,  /* (74) ccons ::= REFERENCES nm eidlist_opt refargs */
   213,  /* (75) ccons ::= defer_subclause */
   213,  /* (76) ccons ::= COLLATE ID|STRING */
   222,  /* (77) generated ::= LP expr RP */
   222,  /* (78) generated ::= LP expr RP ID */
   218,  /* (79) autoinc ::= */
   218,  /* (80) autoinc ::= AUTOINCR */
   220,  /* (81) refargs ::= */
   220,  /* (82) refargs ::= refargs refarg */
   223,  /* (83) refarg ::= MATCH nm */
   223,  /* (84) refarg ::= ON INSERT refact */
   223,  /* (85) refarg ::= ON DELETE refact */
   223,  /* (86) refarg ::= ON UPDATE refact */
   224,  /* (87) refact ::= SET NULL */
   224,  /* (88) refact ::= SET DEFAULT */
   224,  /* (89) refact ::= CASCADE */
   224,  /* (90) refact ::= RESTRICT */
   224,  /* (91) refact ::= NO ACTION */
   221,  /* (92) defer_subclause ::= NOT DEFERRABLE init_deferred_pred_opt */
   221,  /* (93) defer_subclause ::= DEFERRABLE init_deferred_pred_opt */
   225,  /* (94) init_deferred_pred_opt ::= */
   225,  /* (95) init_deferred_pred_opt ::= INITIALLY DEFERRED */
   225,  /* (96) init_deferred_pred_opt ::= INITIALLY IMMEDIATE */
   204,  /* (97) conslist_opt ::= */
   226,  /* (98) tconscomma ::= COMMA */
   227,  /* (99) tcons ::= CONSTRAINT nm */
   227,  /* (100) tcons ::= PRIMARY KEY LP sortlist autoinc RP onconf */
   227,  /* (101) tcons ::= UNIQUE LP sortlist RP onconf */
   227,  /* (102) tcons ::= CHECK LP expr RP onconf */
   227,  /* (103) tcons ::= FOREIGN KEY LP eidlist RP REFERENCES nm eidlist_opt refargs defer_subclause_opt */
   230,  /* (104) defer_subclause_opt ::= */
   216,  /* (105) onconf ::= */
   216,  /* (106) onconf ::= ON CONFLICT resolvetype */
   232,  /* (107) orconf ::= */
   232,  /* (108) orconf ::= OR resolvetype */
   231,  /* (109) resolvetype ::= IGNORE */
   231,  /* (110) resolvetype ::= REPLACE */
   193,  /* (111) cmd ::= DROP TABLE ifexists fullname */
   233,  /* (112) ifexists ::= IF EXISTS */
   233,  /* (113) ifexists ::= */
   193,  /* (114) cmd ::= createkw temp VIEW ifnotexists nm dbnm eidlist_opt AS select */
   193,  /* (115) cmd ::= DROP VIEW ifexists fullname */
   206,  /* (116) select ::= WITH wqlist selectnowith */
   206,  /* (117) select ::= WITH RECURSIVE wqlist selectnowith */
   236,  /* (118) selectnowith ::= selectnowith multiselect_op oneselect */
   237,  /* (119) multiselect_op ::= UNION */
   237,  /* (120) multiselect_op ::= UNION ALL */
   237,  /* (121) multiselect_op ::= EXCEPT|INTERSECT */
   238,  /* (122) oneselect ::= SELECT distinct selcollist from where_opt groupby_opt having_opt window_clause orderby_opt limit_opt */
   248,  /* (123) values ::= VALUES LP nexprlist RP */
   238,  /* (124) oneselect ::= mvalues */
   250,  /* (125) mvalues ::= values COMMA LP nexprlist RP */
   250,  /* (126) mvalues ::= mvalues COMMA LP nexprlist RP */
   240,  /* (127) selcollist ::= sclp scanpt nm DOT STAR */
   253,  /* (128) stl_prefix ::= seltablist joinop */
   253,  /* (129) stl_prefix ::= */
   252,  /* (130) seltablist ::= stl_prefix nm dbnm as on_using */
   252,  /* (131) seltablist ::= stl_prefix nm dbnm as indexed_by on_using */
   252,  /* (132) seltablist ::= stl_prefix nm dbnm LP exprlist RP as on_using */
   252,  /* (133) seltablist ::= stl_prefix LP select RP as on_using */
   252,  /* (134) seltablist ::= stl_prefix LP seltablist RP as on_using */
   201,  /* (135) dbnm ::= */
   201,  /* (136) dbnm ::= DOT nm */
   234,  /* (137) fullname ::= nm */
   234,  /* (138) fullname ::= nm DOT nm */
   258,  /* (139) xfullname ::= nm */
   258,  /* (140) xfullname ::= nm DOT nm */
   258,  /* (141) xfullname ::= nm DOT nm AS nm */
   258,  /* (142) xfullname ::= nm AS nm */
   254,  /* (143) joinop ::= COMMA|JOIN */
   254,  /* (144) joinop ::= JOIN_KW JOIN */
   254,  /* (145) joinop ::= JOIN_KW nm JOIN */
   254,  /* (146) joinop ::= JOIN_KW nm nm JOIN */
   255,  /* (147) on_using ::= ON expr */
   255,  /* (148) on_using ::= USING LP idlist RP */
   255,  /* (149) on_using ::= */
   260,  /* (150) indexed_opt ::= */
   256,  /* (151) indexed_by ::= INDEXED BY nm */
   256,  /* (152) indexed_by ::= NOT INDEXED */
   245,  /* (153) orderby_opt ::= ORDER BY sortlist */
   228,  /* (154) sortlist ::= sortlist COMMA expr sortorder nulls */
   228,  /* (155) sortlist ::= expr sortorder nulls */
   217,  /* (156) sortorder ::= ASC */
   217,  /* (157) sortorder ::= DESC */
   217,  /* (158) sortorder ::= */
   261,  /* (159) nulls ::= NULLS FIRST */
   261,  /* (160) nulls ::= NULLS LAST */
   261,  /* (161) nulls ::= */
   243,  /* (162) groupby_opt ::= GROUP BY nexprlist */
   244,  /* (163) having_opt ::= HAVING expr */
   246,  /* (164) limit_opt ::= LIMIT expr */
   246,  /* (165) limit_opt ::= LIMIT expr OFFSET expr */
   246,  /* (166) limit_opt ::= LIMIT expr COMMA expr */
   193,  /* (167) cmd ::= with DELETE FROM xfullname indexed_opt where_opt_ret */
   263,  /* (168) where_opt_ret ::= */
   263,  /* (169) where_opt_ret ::= WHERE expr */
   263,  /* (170) where_opt_ret ::= RETURNING selcollist */
   263,  /* (171) where_opt_ret ::= WHERE expr RETURNING selcollist */
   193,  /* (172) cmd ::= with UPDATE orconf xfullname indexed_opt SET setlist from where_opt_ret */
   264,  /* (173) setlist ::= setlist COMMA nm EQ expr */
   264,  /* (174) setlist ::= setlist COMMA LP idlist RP EQ expr */
   264,  /* (175) setlist ::= nm EQ expr */
   264,  /* (176) setlist ::= LP idlist RP EQ expr */
   193,  /* (177) cmd ::= with insert_cmd INTO xfullname idlist_opt select upsert */
   193,  /* (178) cmd ::= with insert_cmd INTO xfullname idlist_opt DEFAULT VALUES returning */
   267,  /* (179) upsert ::= */
   267,  /* (180) upsert ::= RETURNING selcollist */
   267,  /* (181) upsert ::= ON CONFLICT LP sortlist RP where_opt DO UPDATE SET setlist where_opt upsert */
   267,  /* (182) upsert ::= ON CONFLICT LP sortlist RP where_opt DO NOTHING upsert */
   267,  /* (183) upsert ::= ON CONFLICT DO NOTHING returning */
   267,  /* (184) upsert ::= ON CONFLICT DO UPDATE SET setlist where_opt returning */
   268,  /* (185) returning ::= RETURNING selcollist */
   265,  /* (186) insert_cmd ::= INSERT orconf */
   265,  /* (187) insert_cmd ::= REPLACE */
   266,  /* (188) idlist_opt ::= */
   266,  /* (189) idlist_opt ::= LP idlist RP */
   259,  /* (190) idlist ::= idlist COMMA nm */
   259,  /* (191) idlist ::= nm */
   215,  /* (192) expr ::= ID|INDEXED|JOIN_KW */
   215,  /* (193) expr ::= nm DOT nm */
   215,  /* (194) expr ::= nm DOT nm DOT nm */
   215,  /* (195) expr ::= VARIABLE */
   215,  /* (196) expr ::= expr COLLATE ID|STRING */
   215,  /* (197) expr ::= CAST LP expr AS typetoken RP */
   215,  /* (198) expr ::= ID|INDEXED|JOIN_KW LP distinct exprlist RP */
   215,  /* (199) expr ::= ID|INDEXED|JOIN_KW LP distinct exprlist ORDER BY sortlist RP */
   215,  /* (200) expr ::= ID|INDEXED|JOIN_KW LP STAR RP */
   215,  /* (201) expr ::= ID|INDEXED|JOIN_KW LP distinct exprlist RP filter_over */
   215,  /* (202) expr ::= ID|INDEXED|JOIN_KW LP distinct exprlist ORDER BY sortlist RP filter_over */
   215,  /* (203) expr ::= ID|INDEXED|JOIN_KW LP STAR RP filter_over */
   214,  /* (204) term ::= CTIME_KW */
   215,  /* (205) expr ::= LP nexprlist COMMA expr RP */
   215,  /* (206) expr ::= expr AND expr */
   215,  /* (207) expr ::= expr OR expr */
   215,  /* (208) expr ::= expr LT|GT|GE|LE expr */
   215,  /* (209) expr ::= expr EQ|NE expr */
   215,  /* (210) expr ::= expr BITAND|BITOR|LSHIFT|RSHIFT expr */
   215,  /* (211) expr ::= expr PLUS|MINUS expr */
   215,  /* (212) expr ::= expr STAR|SLASH|REM expr */
...
static const signed char yyRuleInfoNRhs[] = {
   ...
   -1,  /* (24) term ::= INTEGER */
   -1,  /* (25) input ::= cmdlist */
   -2,  /* (26) cmdlist ::= cmdlist ecmd */
   -1,  /* (27) cmdlist ::= ecmd */
   -1,  /* (28) ecmd ::= SEMI */
   -2,  /* (29) ecmd ::= cmdx SEMI */
   -1,  /* (30) nm ::= STRING */
   -1,  /* (31) selectnowith ::= oneselect */
   -2,  /* (32) sclp ::= selcollist COMMA */
   -1,  /* (33) expr ::= term */
   -1,  /* (34) explain ::= EXPLAIN */
   -3,  /* (35) explain ::= EXPLAIN QUERY PLAN */
  ...
  -10,  /* (103) tcons ::= FOREIGN KEY LP eidlist RP REFERENCES nm eidlist_opt refargs defer_subclause_opt */
   ...
   -3,  /* (116) select ::= WITH wqlist selectnowith */
   -4,  /* (117) select ::= WITH RECURSIVE wqlist selectnowith */
  ...
  -10,  /* (122) oneselect ::= SELECT distinct selcollist from where_opt groupby_opt having_opt window_clause orderby_opt limit_opt */
   -4,  /* (123) values ::= VALUES LP nexprlist RP */
   -1,  /* (124) oneselect ::= mvalues */
   -5,  /* (125) mvalues ::= values COMMA LP nexprlist RP */
   -5,  /* (126) mvalues ::= mvalues COMMA LP nexprlist RP */
   -5,  /* (127) selcollist ::= sclp scanpt nm DOT STAR */
   -2,  /* (128) stl_prefix ::= seltablist joinop */
    0,  /* (129) stl_prefix ::= */
   -5,  /* (130) seltablist ::= stl_prefix nm dbnm as on_using */
   -6,  /* (131) seltablist ::= stl_prefix nm dbnm as indexed_by on_using */
   -8,  /* (132) seltablist ::= stl_prefix nm dbnm LP exprlist RP as on_using */
   -6,  /* (133) seltablist ::= stl_prefix LP select RP as on_using */
   -6,  /* (134) seltablist ::= stl_prefix LP seltablist RP as on_using */
    0,  /* (135) dbnm ::= */
   -2,  /* (136) dbnm ::= DOT nm */
   -1,  /* (137) fullname ::= nm */
   -3,  /* (138) fullname ::= nm DOT nm */
   -1,  /* (139) xfullname ::= nm */
   -3,  /* (140) xfullname ::= nm DOT nm */
   -5,  /* (141) xfullname ::= nm DOT nm AS nm */
   -3,  /* (142) xfullname ::= nm AS nm */
   -1,  /* (143) joinop ::= COMMA|JOIN */
   -2,  /* (144) joinop ::= JOIN_KW JOIN */
   -3,  /* (145) joinop ::= JOIN_KW nm JOIN */
   -4,  /* (146) joinop ::= JOIN_KW nm nm JOIN */
   -2,  /* (147) on_using ::= ON expr */
   -4,  /* (148) on_using ::= USING LP idlist RP */
    0,  /* (149) on_using ::= */
    0,  /* (150) indexed_opt ::= */
   -3,  /* (151) indexed_by ::= INDEXED BY nm */
   -2,  /* (152) indexed_by ::= NOT INDEXED */
   -3,  /* (153) orderby_opt ::= ORDER BY sortlist */
   -5,  /* (154) sortlist ::= sortlist COMMA expr sortorder nulls */
   -3,  /* (155) sortlist ::= expr sortorder nulls */
   -1,  /* (156) sortorder ::= ASC */
   -1,  /* (157) sortorder ::= DESC */
    0,  /* (158) sortorder ::= */
   -2,  /* (159) nulls ::= NULLS FIRST */
   -2,  /* (160) nulls ::= NULLS LAST */
    0,  /* (161) nulls ::= */
   -3,  /* (162) groupby_opt ::= GROUP BY nexprlist */
   -2,  /* (163) having_opt ::= HAVING expr */
   -2,  /* (164) limit_opt ::= LIMIT expr */
   -4,  /* (165) limit_opt ::= LIMIT expr OFFSET expr */
   -4,  /* (166) limit_opt ::= LIMIT expr COMMA expr */
   -6,  /* (167) cmd ::= with DELETE FROM xfullname indexed_opt where_opt_ret */
    0,  /* (168) where_opt_ret ::= */
   -2,  /* (169) where_opt_ret ::= WHERE expr */
   -2,  /* (170) where_opt_ret ::= RETURNING selcollist */
   -4,  /* (171) where_opt_ret ::= WHERE expr RETURNING selcollist */
   -9,  /* (172) cmd ::= with UPDATE orconf xfullname indexed_opt SET setlist from where_opt_ret */
   -5,  /* (173) setlist ::= setlist COMMA nm EQ expr */
   -7,  /* (174) setlist ::= setlist COMMA LP idlist RP EQ expr */
   -3,  /* (175) setlist ::= nm EQ expr */
   -5,  /* (176) setlist ::= LP idlist RP EQ expr */
   -7,  /* (177) cmd ::= with insert_cmd INTO xfullname idlist_opt select upsert */
   -8,  /* (178) cmd ::= with insert_cmd INTO xfullname idlist_opt DEFAULT VALUES returning */
    0,  /* (179) upsert ::= */
   -2,  /* (180) upsert ::= RETURNING selcollist */
  -12,  /* (181) upsert ::= ON CONFLICT LP sortlist RP where_opt DO UPDATE SET setlist where_opt upsert */
   -9,  /* (182) upsert ::= ON CONFLICT LP sortlist RP where_opt DO NOTHING upsert */
   -5,  /* (183) upsert ::= ON CONFLICT DO NOTHING returning */
   -8,  /* (184) upsert ::= ON CONFLICT DO UPDATE SET setlist where_opt returning */
   -2,  /* (185) returning ::= RETURNING selcollist */
   -2,  /* (186) insert_cmd ::= INSERT orconf */
   -1,  /* (187) insert_cmd ::= REPLACE */
    0,  /* (188) idlist_opt ::= */
   -3,  /* (189) idlist_opt ::= LP idlist RP */
   -3,  /* (190) idlist ::= idlist COMMA nm */
   -1,  /* (191) idlist ::= nm */
   -1,  /* (192) expr ::= ID|INDEXED|JOIN_KW */
   -3,  /* (193) expr ::= nm DOT nm */
   -5,  /* (194) expr ::= nm DOT nm DOT nm */
   -1,  /* (195) expr ::= VARIABLE */
...
/********** Begin reduce actions **********************************************/
      ...
      case 27: /* cmdlist ::= ecmd */ yytestcase(yyruleno==27);
      case 31: /* selectnowith ::= oneselect */ yytestcase(yyruleno==31);
      case 33: /* expr ::= term */ yytestcase(yyruleno==33);
{
      ...
      case 22: /* term ::= NULL|FLOAT|BLOB */
{
    ...
    yylhsminor.yy9 = ast_literal(pCtx->astCtx, lit_type, token_span(pCtx, yymsp[0].minor.yy0));
}
  yymsp[0].minor.yy9 = yylhsminor.yy9;
        break;
      case 23: /* term ::= STRING */
{
    yylhsminor.yy9 = ast_literal(pCtx->astCtx, SYNTAQLITE_LITERAL_TYPE_STRING, token_span(pCtx, yymsp[0].minor.yy0));
}
  yymsp[0].minor.yy9 = yylhsminor.yy9;
        break;
      case 24: /* term ::= INTEGER */
{
    yylhsminor.yy9 = ast_literal(pCtx->astCtx, SYNTAQLITE_LITERAL_TYPE_INTEGER, token_span(pCtx, yymsp[0].minor.yy0));
}
  yymsp[0].minor.yy9 = yylhsminor.yy9;
        break;
      case 25: /* input ::= cmdlist */
{
    pCtx->root = yymsp[0].minor.yy9;
}
        break;
      case 26: /* cmdlist ::= cmdlist ecmd */
{
      ...
      case 28: /* ecmd ::= SEMI */
{
    yymsp[0].minor.yy9 = SYNTAQLITE_NULL_NODE;
        ...
        break;
      case 29: /* ecmd ::= cmdx SEMI */
      case 32: /* sclp ::= selcollist COMMA */ yytestcase(yyruleno==32);
{
      ...
      case 30: /* nm ::= STRING */
{
  ...
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      default:
      /* (34) explain ::= EXPLAIN */ yytestcase(yyruleno==34);
      /* (35) explain ::= EXPLAIN QUERY PLAN */ yytestcase(yyruleno==35);
      ...
      /* (116) select ::= WITH wqlist selectnowith */ yytestcase(yyruleno==116);
      /* (117) select ::= WITH RECURSIVE wqlist selectnowith */ yytestcase(yyruleno==117);
      ...
      /* (122) oneselect ::= SELECT distinct selcollist from where_opt groupby_opt having_opt window_clause orderby_opt limit_opt */ yytestcase(yyruleno==122);
      /* (123) values ::= VALUES LP nexprlist RP */ yytestcase(yyruleno==123);
      /* (124) oneselect ::= mvalues */ yytestcase(yyruleno==124);
      /* (125) mvalues ::= values COMMA LP nexprlist RP */ yytestcase(yyruleno==125);
      /* (126) mvalues ::= mvalues COMMA LP nexprlist RP */ yytestcase(yyruleno==126);
      /* (127) selcollist ::= sclp scanpt nm DOT STAR */ yytestcase(yyruleno==127);
      /* (128) stl_prefix ::= seltablist joinop */ yytestcase(yyruleno==128);
      /* (129) stl_prefix ::= */ yytestcase(yyruleno==129);
      /* (130) seltablist ::= stl_prefix nm dbnm as on_using */ yytestcase(yyruleno==130);
      /* (131) seltablist ::= stl_prefix nm dbnm as indexed_by on_using */ yytestcase(yyruleno==131);
      /* (132) seltablist ::= stl_prefix nm dbnm LP exprlist RP as on_using */ yytestcase(yyruleno==132);
      /* (133) seltablist ::= stl_prefix LP select RP as on_using */ yytestcase(yyruleno==133);
      /* (134) seltablist ::= stl_prefix LP seltablist RP as on_using */ yytestcase(yyruleno==134);
      /* (135) dbnm ::= */ yytestcase(yyruleno==135);
      /* (136) dbnm ::= DOT nm */ yytestcase(yyruleno==136);
      /* (137) fullname ::= nm */ yytestcase(yyruleno==137);
      /* (138) fullname ::= nm DOT nm */ yytestcase(yyruleno==138);
      /* (139) xfullname ::= nm */ yytestcase(yyruleno==139);
      /* (140) xfullname ::= nm DOT nm */ yytestcase(yyruleno==140);
      /* (141) xfullname ::= nm DOT nm AS nm */ yytestcase(yyruleno==141);
      /* (142) xfullname ::= nm AS nm */ yytestcase(yyruleno==142);
      /* (143) joinop ::= COMMA|JOIN */ yytestcase(yyruleno==143);
      /* (144) joinop ::= JOIN_KW JOIN */ yytestcase(yyruleno==144);
      /* (145) joinop ::= JOIN_KW nm JOIN */ yytestcase(yyruleno==145);
      /* (146) joinop ::= JOIN_KW nm nm JOIN */ yytestcase(yyruleno==146);
      /* (147) on_using ::= ON expr */ yytestcase(yyruleno==147);
      /* (148) on_using ::= USING LP idlist RP */ yytestcase(yyruleno==148);
      /* (149) on_using ::= */ yytestcase(yyruleno==149);
      /* (150) indexed_opt ::= */ yytestcase(yyruleno==150);
      /* (151) indexed_by ::= INDEXED BY nm */ yytestcase(yyruleno==151);
      /* (152) indexed_by ::= NOT INDEXED */ yytestcase(yyruleno==152);
      /* (153) orderby_opt ::= ORDER BY sortlist */ yytestcase(yyruleno==153);
      /* (154) sortlist ::= sortlist COMMA expr sortorder nulls */ yytestcase(yyruleno==154);
      /* (155) sortlist ::= expr sortorder nulls */ yytestcase(yyruleno==155);
      /* (156) sortorder ::= ASC */ yytestcase(yyruleno==156);
      /* (157) sortorder ::= DESC */ yytestcase(yyruleno==157);
      /* (158) sortorder ::= */ yytestcase(yyruleno==158);
      /* (159) nulls ::= NULLS FIRST */ yytestcase(yyruleno==159);
      /* (160) nulls ::= NULLS LAST */ yytestcase(yyruleno==160);
      /* (161) nulls ::= */ yytestcase(yyruleno==161);
      /* (162) groupby_opt ::= GROUP BY nexprlist */ yytestcase(yyruleno==162);
      /* (163) having_opt ::= HAVING expr */ yytestcase(yyruleno==163);
      /* (164) limit_opt ::= LIMIT expr */ yytestcase(yyruleno==164);
      /* (165) limit_opt ::= LIMIT expr OFFSET expr */ yytestcase(yyruleno==165);
      /* (166) limit_opt ::= LIMIT expr COMMA expr */ yytestcase(yyruleno==166);
      /* (167) cmd ::= with DELETE FROM xfullname indexed_opt where_opt_ret */ yytestcase(yyruleno==167);
      /* (168) where_opt_ret ::= */ yytestcase(yyruleno==168);
      /* (169) where_opt_ret ::= WHERE expr */ yytestcase(yyruleno==169);
      /* (170) where_opt_ret ::= RETURNING selcollist */ yytestcase(yyruleno==170);
      /* (171) where_opt_ret ::= WHERE expr RETURNING selcollist */ yytestcase(yyruleno==171);
      /* (172) cmd ::= with UPDATE orconf xfullname indexed_opt SET setlist from where_opt_ret */ yytestcase(yyruleno==172);
      /* (173) setlist ::= setlist COMMA nm EQ expr */ yytestcase(yyruleno==173);
      /* (174) setlist ::= setlist COMMA LP idlist RP EQ expr */ yytestcase(yyruleno==174);
      /* (175) setlist ::= nm EQ expr */ yytestcase(yyruleno==175);
      /* (176) setlist ::= LP idlist RP EQ expr */ yytestcase(yyruleno==176);
      /* (177) cmd ::= with insert_cmd INTO xfullname idlist_opt select upsert */ yytestcase(yyruleno==177);
      /* (178) cmd ::= with insert_cmd INTO xfullname idlist_opt DEFAULT VALUES returning */ yytestcase(yyruleno==178);
      /* (179) upsert ::= */ yytestcase(yyruleno==179);
      /* (180) upsert ::= RETURNING selcollist */ yytestcase(yyruleno==180);
      /* (181) upsert ::= ON CONFLICT LP sortlist RP where_opt DO UPDATE SET setlist where_opt upsert */ yytestcase(yyruleno==181);
      /* (182) upsert ::= ON CONFLICT LP sortlist RP where_opt DO NOTHING upsert */ yytestcase(yyruleno==182);
      /* (183) upsert ::= ON CONFLICT DO NOTHING returning */ yytestcase(yyruleno==183);
      /* (184) upsert ::= ON CONFLICT DO UPDATE SET setlist where_opt returning */ yytestcase(yyruleno==184);
      /* (185) returning ::= RETURNING selcollist */ yytestcase(yyruleno==185);
      /* (186) insert_cmd ::= INSERT orconf */ yytestcase(yyruleno==186);
      /* (187) insert_cmd ::= REPLACE */ yytestcase(yyruleno==187);
      /* (188) idlist_opt ::= */ yytestcase(yyruleno==188);
      /* (189) idlist_opt ::= LP idlist RP */ yytestcase(yyruleno==189);
      /* (190) idlist ::= idlist COMMA nm */ yytestcase(yyruleno==190);
      /* (191) idlist ::= nm (OPTIMIZED OUT) */ assert(yyruleno!=191);
      /* (192) expr ::= ID|INDEXED|JOIN_KW */ yytestcase(yyruleno==192);
      /* (193) expr ::= nm DOT nm */ yytestcase(yyruleno==193);
      /* (194) expr ::= nm DOT nm DOT nm */ yytestcase(yyruleno==194);
