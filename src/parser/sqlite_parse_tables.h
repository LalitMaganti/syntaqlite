#ifndef SYNQ_SRC_PARSER_SQLITE_PARSE_TABLES_H
#define SYNQ_SRC_PARSER_SQLITE_PARSE_TABLES_H

#include "src/parser/sqlite_parse_defs.h"
...
/* Reduce function */
static void synq_parser_reduce(
  synq_yyParser *yypParser,
  unsigned int yyruleno,
  synq_yyStackEntry *yymsp,
  int yyLookahead,
  synq_sqlite3ParserTOKENTYPE yyLookaheadToken
  synq_sqlite3ParserCTX_PDECL
) {
...
#endif /* SYNQ_SRC_PARSER_SQLITE_PARSE_TABLES_H */
