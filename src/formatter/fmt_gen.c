...
static const SynqFmtEnumEntry fmt_binary_expr_entries_1[] = {
    ...
    { SYNTAQLITE_BINARY_OP_STAR, "*" },
    { SYNTAQLITE_BINARY_OP_SLASH, "/" },
    { SYNTAQLITE_BINARY_OP_REM, "%" },
    { SYNTAQLITE_BINARY_OP_LT, "<" },
    { SYNTAQLITE_BINARY_OP_GT, ">" },
    { SYNTAQLITE_BINARY_OP_LE, "<=" },
    { SYNTAQLITE_BINARY_OP_GE, ">=" },
    { SYNTAQLITE_BINARY_OP_EQ, "=" },
    { SYNTAQLITE_BINARY_OP_NE, "!=" },
    { SYNTAQLITE_BINARY_OP_AND, "AND" },
    { SYNTAQLITE_BINARY_OP_OR, "OR" },
    { SYNTAQLITE_BINARY_OP_BITAND, "&" },
    { SYNTAQLITE_BINARY_OP_BITOR, "|" },
    { SYNTAQLITE_BINARY_OP_LSHIFT, "<<" },
    { SYNTAQLITE_BINARY_OP_RSHIFT, ">>" },
    { SYNTAQLITE_BINARY_OP_CONCAT, "||" },
...
static const SynqFmtOp fmt_is_expr[] = {
    ...
    FOP_CASE(SYNTAQLITE_IS_OP_ISNULL),
    FOP_SEQ(2),
    FOP_CHILD(IsExpr, left),
    FOP_KW(" ISNULL"),
    FOP_CASE(SYNTAQLITE_IS_OP_NOTNULL),
    FOP_SEQ(2),
    FOP_CHILD(IsExpr, left),
    FOP_KW(" NOTNULL"),
    FOP_CASE(SYNTAQLITE_IS_OP_IS),
    FOP_SEQ(3),
    FOP_CHILD(IsExpr, left),
    FOP_KW(" IS "),
    FOP_CHILD(IsExpr, right),
    FOP_CASE(SYNTAQLITE_IS_OP_IS_NOT),
    FOP_SEQ(3),
    FOP_CHILD(IsExpr, left),
    FOP_KW(" IS NOT "),
    FOP_CHILD(IsExpr, right),
    FOP_CASE(SYNTAQLITE_IS_OP_IS_NOT_DISTINCT),
    FOP_SEQ(3),
    FOP_CHILD(IsExpr, left),
    FOP_KW(" IS NOT DISTINCT FROM "),
    FOP_CHILD(IsExpr, right),
    FOP_CASE(SYNTAQLITE_IS_OP_IS_DISTINCT),
    FOP_SEQ(3),
    FOP_CHILD(IsExpr, left),
...
static const SynqFmtOp fmt_between_expr[] = {
    ...
    FOP_IF_ENUM_ELSE(BetweenExpr, negated, SYNTAQLITE_BOOL_TRUE),
    FOP_KW(" NOT BETWEEN "),
    FOP_KW(" BETWEEN "),
...
static const SynqFmtOp fmt_like_expr[] = {
    ...
    FOP_IF_ENUM_ELSE(LikeExpr, negated, SYNTAQLITE_BOOL_TRUE),
    FOP_KW(" NOT LIKE "),
    FOP_KW(" LIKE "),
...
static const SynqFmtEnumEntry fmt_compound_select_entries_1[] = {
    { SYNTAQLITE_COMPOUND_OP_UNION, "UNION" },
    { SYNTAQLITE_COMPOUND_OP_UNION_ALL, "UNION ALL" },
    { SYNTAQLITE_COMPOUND_OP_INTERSECT, "INTERSECT" },
    { SYNTAQLITE_COMPOUND_OP_EXCEPT, "EXCEPT" },
};
...
static const SynqFmtOp fmt_in_expr[] = {
    ...
    FOP_IF_ENUM_ELSE(InExpr, negated, SYNTAQLITE_BOOL_TRUE),
    FOP_KW(" NOT IN "),
    FOP_KW(" IN "),
    FOP_KW("("),
...
static const SynqFmtOp fmt_cte_definition[] = {
    ...
    FOP_KW(")"),
    FOP_KW(" AS "),
    FOP_IF_ENUM(CteDefinition, materialized, SYNTAQLITE_MATERIALIZED_MATERIALIZED),
    FOP_KW("MATERIALIZED "),
    FOP_IF_ENUM(CteDefinition, materialized, SYNTAQLITE_MATERIALIZED_NOT_MATERIALIZED),
...
static const SynqFmtOp fmt_with_clause[] = {
    FOP_SEQ(4),
    FOP_IF_ENUM_ELSE(WithClause, recursive, SYNTAQLITE_BOOL_TRUE),
...
static const SynqFmtOp fmt_raise_expr[] = {
    ...
    FOP_CASE(SYNTAQLITE_RAISE_TYPE_IGNORE),
    FOP_KW("IGNORE"),
    FOP_CASE(SYNTAQLITE_RAISE_TYPE_ROLLBACK),
    FOP_KW("ROLLBACK"),
    FOP_CASE(SYNTAQLITE_RAISE_TYPE_ABORT),
    FOP_KW("ABORT"),
    FOP_CASE(SYNTAQLITE_RAISE_TYPE_FAIL),
    FOP_KW("FAIL"),
...
static const SynqFmtEnumEntry fmt_join_clause_entries_1[] = {
    { SYNTAQLITE_JOIN_TYPE_INNER, "JOIN" },
    { SYNTAQLITE_JOIN_TYPE_LEFT, "LEFT JOIN" },
    { SYNTAQLITE_JOIN_TYPE_RIGHT, "RIGHT JOIN" },
    { SYNTAQLITE_JOIN_TYPE_FULL, "FULL JOIN" },
    { SYNTAQLITE_JOIN_TYPE_CROSS, "CROSS JOIN" },
    { SYNTAQLITE_JOIN_TYPE_NATURAL_INNER, "NATURAL JOIN" },
    { SYNTAQLITE_JOIN_TYPE_NATURAL_LEFT, "NATURAL LEFT JOIN" },
    { SYNTAQLITE_JOIN_TYPE_NATURAL_RIGHT, "NATURAL RIGHT JOIN" },
    { SYNTAQLITE_JOIN_TYPE_NATURAL_FULL, "NATURAL FULL JOIN" },
    { SYNTAQLITE_JOIN_TYPE_COMMA, "," },
};

static const SynqFmtOp fmt_join_clause[] = {
    FOP_SWITCH_DEFAULT(JoinClause, join_type, 1),
    FOP_CASE(SYNTAQLITE_JOIN_TYPE_COMMA),
    FOP_SEQ(5),
...
static const SynqFmtOp fmt_update_stmt[] = {
    ...
    FOP_CASE(SYNTAQLITE_CONFLICT_ACTION_ROLLBACK),
    FOP_KW(" OR ROLLBACK"),
    FOP_CASE(SYNTAQLITE_CONFLICT_ACTION_ABORT),
    FOP_KW(" OR ABORT"),
    FOP_CASE(SYNTAQLITE_CONFLICT_ACTION_FAIL),
    FOP_KW(" OR FAIL"),
    FOP_CASE(SYNTAQLITE_CONFLICT_ACTION_IGNORE),
    FOP_KW(" OR IGNORE"),
    FOP_CASE(SYNTAQLITE_CONFLICT_ACTION_REPLACE),
    FOP_KW(" OR REPLACE"),
    FOP_KW(" "),
...
static const SynqFmtOp fmt_insert_stmt[] = {
    FOP_SEQ(5),
    FOP_IF_ENUM_ELSE(InsertStmt, conflict_action, SYNTAQLITE_CONFLICT_ACTION_REPLACE),
    FOP_KW("REPLACE"),
    FOP_SEQ(2),
    FOP_KW("INSERT"),
...
static const SynqFmtEnumEntry fmt_drop_stmt_entries_1[] = {
    { SYNTAQLITE_DROP_OBJECT_TYPE_TABLE, "TABLE" },
    { SYNTAQLITE_DROP_OBJECT_TYPE_INDEX, "INDEX" },
    { SYNTAQLITE_DROP_OBJECT_TYPE_VIEW, "VIEW" },
    { SYNTAQLITE_DROP_OBJECT_TYPE_TRIGGER, "TRIGGER" },
};
...
static const SynqFmtOp fmt_drop_stmt[] = {
    ...
    FOP_IF_ENUM(DropStmt, if_exists, SYNTAQLITE_BOOL_TRUE),
    FOP_KW(" IF EXISTS"),
    FOP_KW(" "),
...
static const SynqFmtOp fmt_alter_table_stmt[] = {
    ...
    FOP_CASE(SYNTAQLITE_ALTER_OP_RENAME_TABLE),
    FOP_SEQ(2),
    FOP_KW("RENAME TO "),
    FOP_SPAN(AlterTableStmt, new_name),
    FOP_CASE(SYNTAQLITE_ALTER_OP_RENAME_COLUMN),
    FOP_SEQ(4),
    FOP_KW("RENAME COLUMN "),
    FOP_SPAN(AlterTableStmt, old_name),
    FOP_KW(" TO "),
    FOP_SPAN(AlterTableStmt, new_name),
    FOP_CASE(SYNTAQLITE_ALTER_OP_DROP_COLUMN),
    FOP_SEQ(2),
    FOP_KW("DROP COLUMN "),
    FOP_SPAN(AlterTableStmt, old_name),
    FOP_CASE(SYNTAQLITE_ALTER_OP_ADD_COLUMN),
    FOP_SEQ(2),
    FOP_KW("ADD COLUMN "),
    FOP_SPAN(AlterTableStmt, old_name),
};
...
static const SynqFmtEnumEntry fmt_transaction_stmt_entries_1[] = {
    { SYNTAQLITE_TRANSACTION_TYPE_IMMEDIATE, " IMMEDIATE" },
    { SYNTAQLITE_TRANSACTION_TYPE_EXCLUSIVE, " EXCLUSIVE" },
};

static const SynqFmtOp fmt_transaction_stmt[] = {
    FOP_SWITCH(TransactionStmt, op, 3),
    FOP_CASE(SYNTAQLITE_TRANSACTION_OP_BEGIN),
    FOP_SEQ(2),
    FOP_KW("BEGIN"),
    FOP_ENUM_DISPLAY(TransactionStmt, trans_type, fmt_transaction_stmt_entries_1, 2),
    FOP_CASE(SYNTAQLITE_TRANSACTION_OP_COMMIT),
    FOP_KW("COMMIT"),
    FOP_CASE(SYNTAQLITE_TRANSACTION_OP_ROLLBACK),
    FOP_KW("ROLLBACK"),
};

static const SynqFmtOp fmt_savepoint_stmt[] = {
    FOP_SWITCH(SavepointStmt, op, 3),
    FOP_CASE(SYNTAQLITE_SAVEPOINT_OP_SAVEPOINT),
    FOP_SEQ(2),
    FOP_KW("SAVEPOINT "),
    FOP_SPAN(SavepointStmt, savepoint_name),
    FOP_CASE(SYNTAQLITE_SAVEPOINT_OP_RELEASE),
    FOP_SEQ(2),
    FOP_KW("RELEASE SAVEPOINT "),
    FOP_SPAN(SavepointStmt, savepoint_name),
    FOP_CASE(SYNTAQLITE_SAVEPOINT_OP_ROLLBACK_TO),
    FOP_SEQ(2),
...
static const SynqFmtOp fmt_pragma_stmt[] = {
    ...
    FOP_CASE(SYNTAQLITE_PRAGMA_FORM_EQ),
    FOP_SEQ(2),
    FOP_KW(" = "),
    FOP_SPAN(PragmaStmt, value),
    FOP_CASE(SYNTAQLITE_PRAGMA_FORM_CALL),
    FOP_SEQ(3),
    FOP_KW("("),
    FOP_SPAN(PragmaStmt, value),
    FOP_KW(")"),
...
static const SynqFmtOp fmt_analyze_stmt[] = {
    FOP_SEQ(2),
    FOP_IF_ENUM_ELSE(AnalyzeStmt, kind, SYNTAQLITE_ANALYZE_KIND_REINDEX),
    FOP_KW("REINDEX"),
    FOP_KW("ANALYZE"),
...
static const SynqFmtOp fmt_explain_stmt[] = {
    FOP_SEQ(3),
    FOP_IF_ENUM_ELSE(ExplainStmt, explain_mode, SYNTAQLITE_EXPLAIN_MODE_QUERY_PLAN),
...
static const SynqFmtOp fmt_create_index_stmt[] = {
    ...
    FOP_SEQ(13),
    FOP_KW("CREATE"),
    FOP_IF_ENUM(CreateIndexStmt, is_unique, SYNTAQLITE_BOOL_TRUE),
    FOP_KW(" UNIQUE"),
    FOP_KW(" INDEX"),
    FOP_IF_ENUM(CreateIndexStmt, if_not_exists, SYNTAQLITE_BOOL_TRUE),
...
static const SynqFmtOp fmt_create_view_stmt[] = {
    FOP_SEQ(11),
    FOP_KW("CREATE"),
    FOP_IF_ENUM(CreateViewStmt, is_temp, SYNTAQLITE_BOOL_TRUE),
    FOP_KW(" TEMP"),
    FOP_KW(" VIEW"),
    FOP_IF_ENUM(CreateViewStmt, if_not_exists, SYNTAQLITE_BOOL_TRUE),
    FOP_KW(" IF NOT EXISTS"),
    FOP_KW(" "),
...
static const SynqFmtOp fmt_foreign_key_clause[] = {
    ...
    FOP_CASE(SYNTAQLITE_FOREIGN_KEY_ACTION_SET_NULL),
    FOP_KW(" ON DELETE SET NULL"),
    FOP_CASE(SYNTAQLITE_FOREIGN_KEY_ACTION_SET_DEFAULT),
    FOP_KW(" ON DELETE SET DEFAULT"),
    FOP_CASE(SYNTAQLITE_FOREIGN_KEY_ACTION_CASCADE),
    FOP_KW(" ON DELETE CASCADE"),
    FOP_CASE(SYNTAQLITE_FOREIGN_KEY_ACTION_RESTRICT),
    ...
    FOP_IF_ENUM(ForeignKeyClause, is_deferred, SYNTAQLITE_BOOL_TRUE),
...
static const SynqFmtOp fmt_column_constraint[] = {
    ...
    FOP_CASE(SYNTAQLITE_COLUMN_CONSTRAINT_KIND_PRIMARY_KEY),
    FOP_SEQ(4),
    FOP_KW("PRIMARY KEY"),
    FOP_IF_ENUM(ColumnConstraint, sort_order, SYNTAQLITE_SORT_ORDER_DESC),
    FOP_KW(" DESC"),
    FOP_IF_ENUM(ColumnConstraint, is_autoincrement, SYNTAQLITE_BOOL_TRUE),
    ...
    FOP_CASE(SYNTAQLITE_COLUMN_CONSTRAINT_KIND_NOT_NULL),
    FOP_SEQ(2),
    FOP_KW("NOT NULL"),
    FOP_SWITCH(ColumnConstraint, onconf, 5),
    FOP_CASE(SYNTAQLITE_CONFLICT_ACTION_ROLLBACK),
    ...
    FOP_CASE(SYNTAQLITE_CONFLICT_ACTION_REPLACE),
    FOP_KW(" ON CONFLICT REPLACE"),
    FOP_CASE(SYNTAQLITE_COLUMN_CONSTRAINT_KIND_UNIQUE),
    FOP_SEQ(2),
    FOP_KW("UNIQUE"),
    FOP_SWITCH(ColumnConstraint, onconf, 5),
    FOP_CASE(SYNTAQLITE_CONFLICT_ACTION_ROLLBACK),
    ...
    FOP_CASE(SYNTAQLITE_CONFLICT_ACTION_REPLACE),
    FOP_KW(" ON CONFLICT REPLACE"),
    FOP_CASE(SYNTAQLITE_COLUMN_CONSTRAINT_KIND_CHECK),
    FOP_SEQ(3),
    FOP_KW("CHECK("),
    FOP_CHILD(ColumnConstraint, check_expr),
    FOP_KW(")"),
    FOP_CASE(SYNTAQLITE_COLUMN_CONSTRAINT_KIND_DEFAULT),
    FOP_SEQ(2),
    FOP_KW("DEFAULT "),
    FOP_CHILD(ColumnConstraint, default_expr),
    FOP_CASE(SYNTAQLITE_COLUMN_CONSTRAINT_KIND_COLLATE),
    FOP_SEQ(2),
    FOP_KW("COLLATE "),
    FOP_SPAN(ColumnConstraint, collation_name),
    FOP_CASE(SYNTAQLITE_COLUMN_CONSTRAINT_KIND_REFERENCES),
    FOP_CHILD(ColumnConstraint, fk_clause),
    FOP_CASE(SYNTAQLITE_COLUMN_CONSTRAINT_KIND_GENERATED),
    FOP_SEQ(4),
    FOP_KW("AS ("),
    FOP_CHILD(ColumnConstraint, generated_expr),
    FOP_KW(")"),
    FOP_IF_ENUM(ColumnConstraint, generated_storage, SYNTAQLITE_GENERATED_COLUMN_STORAGE_STORED),
    FOP_KW(" STORED"),
    FOP_CASE(SYNTAQLITE_COLUMN_CONSTRAINT_KIND_NULL),
    FOP_KW("NULL"),
};
...
static const SynqFmtOp fmt_table_constraint[] = {
    ...
    FOP_CASE(SYNTAQLITE_TABLE_CONSTRAINT_KIND_PRIMARY_KEY),
    FOP_SEQ(4),
    FOP_KW("PRIMARY KEY("),
    ...
    FOP_CASE(SYNTAQLITE_CONFLICT_ACTION_REPLACE),
    FOP_KW(" ON CONFLICT REPLACE"),
    FOP_CASE(SYNTAQLITE_TABLE_CONSTRAINT_KIND_UNIQUE),
    FOP_SEQ(4),
    FOP_KW("UNIQUE("),
    FOP_CHILD(TableConstraint, columns),
    FOP_KW(")"),
    ...
    FOP_CASE(SYNTAQLITE_CONFLICT_ACTION_REPLACE),
    FOP_KW(" ON CONFLICT REPLACE"),
    FOP_CASE(SYNTAQLITE_TABLE_CONSTRAINT_KIND_CHECK),
    FOP_SEQ(3),
    FOP_KW("CHECK("),
    FOP_CHILD(TableConstraint, check_expr),
    FOP_KW(")"),
    FOP_CASE(SYNTAQLITE_TABLE_CONSTRAINT_KIND_FOREIGN_KEY),
    FOP_SEQ(4),
    FOP_KW("FOREIGN KEY("),
    FOP_CHILD(TableConstraint, columns),
    FOP_KW(") "),
...
static const SynqFmtOp fmt_create_table_stmt[] = {
    ...
    FOP_SEQ(11),
    FOP_KW("CREATE"),
    FOP_IF_ENUM(CreateTableStmt, is_temp, SYNTAQLITE_BOOL_TRUE),
    FOP_KW(" TEMP"),
    FOP_KW(" TABLE"),
    FOP_IF_ENUM(CreateTableStmt, if_not_exists, SYNTAQLITE_BOOL_TRUE),
    FOP_KW(" IF NOT EXISTS"),
    FOP_KW(" "),
...
static const SynqFmtOp fmt_frame_bound[] = {
    ...
    FOP_CASE(SYNTAQLITE_FRAME_BOUND_TYPE_UNBOUNDED_PRECEDING),
    FOP_KW("UNBOUNDED PRECEDING"),
    FOP_CASE(SYNTAQLITE_FRAME_BOUND_TYPE_EXPR_PRECEDING),
    FOP_SEQ(2),
    FOP_CHILD(FrameBound, expr),
    FOP_KW(" PRECEDING"),
    FOP_CASE(SYNTAQLITE_FRAME_BOUND_TYPE_CURRENT_ROW),
    FOP_KW("CURRENT ROW"),
    FOP_CASE(SYNTAQLITE_FRAME_BOUND_TYPE_EXPR_FOLLOWING),
    FOP_SEQ(2),
    FOP_CHILD(FrameBound, expr),
    FOP_KW(" FOLLOWING"),
    FOP_CASE(SYNTAQLITE_FRAME_BOUND_TYPE_UNBOUNDED_FOLLOWING),
...
static const SynqFmtOp fmt_frame_spec[] = {
    ...
    FOP_CASE(SYNTAQLITE_FRAME_TYPE_RANGE),
    FOP_KW("RANGE"),
    FOP_CASE(SYNTAQLITE_FRAME_TYPE_ROWS),
    FOP_KW("ROWS"),
    FOP_CASE(SYNTAQLITE_FRAME_TYPE_GROUPS),
    FOP_KW("GROUPS"),
    FOP_KW(" BETWEEN "),
    ...
    FOP_CASE(SYNTAQLITE_FRAME_EXCLUDE_NO_OTHERS),
    FOP_KW(" EXCLUDE NO OTHERS"),
    FOP_CASE(SYNTAQLITE_FRAME_EXCLUDE_CURRENT_ROW),
    FOP_KW(" EXCLUDE CURRENT ROW"),
    FOP_CASE(SYNTAQLITE_FRAME_EXCLUDE_GROUP),
    FOP_KW(" EXCLUDE GROUP"),
    FOP_CASE(SYNTAQLITE_FRAME_EXCLUDE_TIES),
    FOP_KW(" EXCLUDE TIES"),
};
...
static const SynqFmtOp fmt_trigger_event[] = {
    ...
    FOP_CASE(SYNTAQLITE_TRIGGER_EVENT_TYPE_DELETE),
    FOP_KW("DELETE"),
    FOP_CASE(SYNTAQLITE_TRIGGER_EVENT_TYPE_INSERT),
    FOP_KW("INSERT"),
    FOP_CASE(SYNTAQLITE_TRIGGER_EVENT_TYPE_UPDATE),
    FOP_SEQ(2),
    FOP_KW("UPDATE"),
...
static const SynqFmtOp fmt_create_trigger_stmt[] = {
    FOP_SEQ(19),
    FOP_KW("CREATE"),
    FOP_IF_ENUM(CreateTriggerStmt, is_temp, SYNTAQLITE_BOOL_TRUE),
    FOP_KW(" TEMP"),
    FOP_KW(" TRIGGER"),
    FOP_IF_ENUM(CreateTriggerStmt, if_not_exists, SYNTAQLITE_BOOL_TRUE),
    FOP_KW(" IF NOT EXISTS"),
    FOP_KW(" "),
    ...
    FOP_CASE(SYNTAQLITE_TRIGGER_TIMING_BEFORE),
    FOP_KW("BEFORE"),
    FOP_CASE(SYNTAQLITE_TRIGGER_TIMING_AFTER),
    FOP_KW("AFTER"),
    FOP_CASE(SYNTAQLITE_TRIGGER_TIMING_INSTEAD_OF),
    FOP_KW("INSTEAD OF"),
    FOP_KW(" "),
...
static const SynqFmtOp fmt_create_virtual_table_stmt[] = {
    ...
    FOP_IF_ENUM(CreateVirtualTableStmt, if_not_exists, SYNTAQLITE_BOOL_TRUE),
    FOP_KW(" IF NOT EXISTS"),
    FOP_KW(" "),
...
const SynqFmtOp *synq_fmt_recipes[SYNTAQLITE_NODE_COUNT] = {
    [SYNTAQLITE_NODE_BINARY_EXPR] = fmt_binary_expr,
    [SYNTAQLITE_NODE_UNARY_EXPR] = fmt_unary_expr,
    [SYNTAQLITE_NODE_LITERAL] = fmt_literal,
    [SYNTAQLITE_NODE_EXPR_LIST] = synq_fmt_default_comma_list,
    [SYNTAQLITE_NODE_RESULT_COLUMN] = fmt_result_column,
    [SYNTAQLITE_NODE_RESULT_COLUMN_LIST] = synq_fmt_default_comma_list,
    [SYNTAQLITE_NODE_SELECT_STMT] = fmt_select_stmt,
    [SYNTAQLITE_NODE_ORDERING_TERM] = fmt_ordering_term,
    [SYNTAQLITE_NODE_ORDER_BY_LIST] = synq_fmt_default_comma_list,
    [SYNTAQLITE_NODE_LIMIT_CLAUSE] = fmt_limit_clause,
    [SYNTAQLITE_NODE_COLUMN_REF] = fmt_column_ref,
    [SYNTAQLITE_NODE_FUNCTION_CALL] = fmt_function_call,
    [SYNTAQLITE_NODE_IS_EXPR] = fmt_is_expr,
    [SYNTAQLITE_NODE_BETWEEN_EXPR] = fmt_between_expr,
    [SYNTAQLITE_NODE_LIKE_EXPR] = fmt_like_expr,
    [SYNTAQLITE_NODE_CASE_EXPR] = fmt_case_expr,
    [SYNTAQLITE_NODE_CASE_WHEN] = fmt_case_when,
    [SYNTAQLITE_NODE_CASE_WHEN_LIST] = fmt_case_when_list,
    [SYNTAQLITE_NODE_COMPOUND_SELECT] = fmt_compound_select,
    [SYNTAQLITE_NODE_SUBQUERY_EXPR] = fmt_subquery_expr,
    [SYNTAQLITE_NODE_EXISTS_EXPR] = fmt_exists_expr,
    [SYNTAQLITE_NODE_IN_EXPR] = fmt_in_expr,
    [SYNTAQLITE_NODE_VARIABLE] = fmt_variable,
    [SYNTAQLITE_NODE_COLLATE_EXPR] = fmt_collate_expr,
    [SYNTAQLITE_NODE_CAST_EXPR] = fmt_cast_expr,
    [SYNTAQLITE_NODE_VALUES_ROW_LIST] = fmt_values_row_list,
    [SYNTAQLITE_NODE_VALUES_CLAUSE] = fmt_values_clause,
    [SYNTAQLITE_NODE_CTE_DEFINITION] = fmt_cte_definition,
    [SYNTAQLITE_NODE_CTE_LIST] = synq_fmt_default_comma_list,
    [SYNTAQLITE_NODE_WITH_CLAUSE] = fmt_with_clause,
    [SYNTAQLITE_NODE_AGGREGATE_FUNCTION_CALL] = fmt_aggregate_function_call,
    [SYNTAQLITE_NODE_RAISE_EXPR] = fmt_raise_expr,
    [SYNTAQLITE_NODE_TABLE_REF] = fmt_table_ref,
    [SYNTAQLITE_NODE_SUBQUERY_TABLE_SOURCE] = fmt_subquery_table_source,
    [SYNTAQLITE_NODE_JOIN_CLAUSE] = fmt_join_clause,
    [SYNTAQLITE_NODE_JOIN_PREFIX] = fmt_join_prefix,
    [SYNTAQLITE_NODE_DELETE_STMT] = fmt_delete_stmt,
    [SYNTAQLITE_NODE_SET_CLAUSE] = fmt_set_clause,
    [SYNTAQLITE_NODE_SET_CLAUSE_LIST] = synq_fmt_default_comma_list,
    [SYNTAQLITE_NODE_UPDATE_STMT] = fmt_update_stmt,
    [SYNTAQLITE_NODE_INSERT_STMT] = fmt_insert_stmt,
    [SYNTAQLITE_NODE_QUALIFIED_NAME] = fmt_qualified_name,
    [SYNTAQLITE_NODE_DROP_STMT] = fmt_drop_stmt,
    [SYNTAQLITE_NODE_ALTER_TABLE_STMT] = fmt_alter_table_stmt,
    [SYNTAQLITE_NODE_TRANSACTION_STMT] = fmt_transaction_stmt,
    [SYNTAQLITE_NODE_SAVEPOINT_STMT] = fmt_savepoint_stmt,
    [SYNTAQLITE_NODE_PRAGMA_STMT] = fmt_pragma_stmt,
    [SYNTAQLITE_NODE_ANALYZE_STMT] = fmt_analyze_stmt,
    [SYNTAQLITE_NODE_ATTACH_STMT] = fmt_attach_stmt,
    [SYNTAQLITE_NODE_DETACH_STMT] = fmt_detach_stmt,
    [SYNTAQLITE_NODE_VACUUM_STMT] = fmt_vacuum_stmt,
    [SYNTAQLITE_NODE_EXPLAIN_STMT] = fmt_explain_stmt,
    [SYNTAQLITE_NODE_CREATE_INDEX_STMT] = fmt_create_index_stmt,
    [SYNTAQLITE_NODE_CREATE_VIEW_STMT] = fmt_create_view_stmt,
    [SYNTAQLITE_NODE_FOREIGN_KEY_CLAUSE] = fmt_foreign_key_clause,
    [SYNTAQLITE_NODE_COLUMN_CONSTRAINT] = fmt_column_constraint,
    [SYNTAQLITE_NODE_COLUMN_CONSTRAINT_LIST] = fmt_column_constraint_list,
    [SYNTAQLITE_NODE_COLUMN_DEF] = fmt_column_def,
    [SYNTAQLITE_NODE_COLUMN_DEF_LIST] = fmt_column_def_list,
    [SYNTAQLITE_NODE_TABLE_CONSTRAINT] = fmt_table_constraint,
    [SYNTAQLITE_NODE_TABLE_CONSTRAINT_LIST] = fmt_table_constraint_list,
    [SYNTAQLITE_NODE_CREATE_TABLE_STMT] = fmt_create_table_stmt,
    [SYNTAQLITE_NODE_FRAME_BOUND] = fmt_frame_bound,
    [SYNTAQLITE_NODE_FRAME_SPEC] = fmt_frame_spec,
    [SYNTAQLITE_NODE_WINDOW_DEF] = fmt_window_def,
    [SYNTAQLITE_NODE_WINDOW_DEF_LIST] = synq_fmt_default_comma_list,
    [SYNTAQLITE_NODE_NAMED_WINDOW_DEF] = fmt_named_window_def,
    [SYNTAQLITE_NODE_NAMED_WINDOW_DEF_LIST] = synq_fmt_default_comma_list,
    [SYNTAQLITE_NODE_FILTER_OVER] = fmt_filter_over,
    [SYNTAQLITE_NODE_TRIGGER_EVENT] = fmt_trigger_event,
    [SYNTAQLITE_NODE_TRIGGER_CMD_LIST] = fmt_trigger_cmd_list,
    [SYNTAQLITE_NODE_CREATE_TRIGGER_STMT] = fmt_create_trigger_stmt,
    [SYNTAQLITE_NODE_CREATE_VIRTUAL_TABLE_STMT] = fmt_create_virtual_table_stmt,
};
